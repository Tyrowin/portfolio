...
function getFileSystemDirectoryByPath(
  ...
  if (node.value.kind !== 'directory') {
    return Err(Error('node type is not a directory'));
  }

  return Ok(node.value);
}

function buildPathNodesFromDirectoryEntry(
  node: FileSystemNode
): FileSystemDirectory[] {
    ...
    <div className={styles.container}>
      <div className={styles.content}>
        <div className={styles.locations}>
          <div className={styles.header}>
            ...
            >
              <div
                className={[
                  'spritesheet-btn-icon',
                  styles['icon-create-directory'],
                ].join(' ')}
              ></div>
            </button>
            <button
        ...
        <div className={styles.folder}>
          <div className={styles.path}>{locations}</div>
          <FolderView
            directory={path}
