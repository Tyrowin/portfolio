...
const BubbleSortLoader = dynamic(
  () => import('./Algorithms/Sorting/BubbleSort'),
  { loading: Loader }
);
const BogoSortLoader = dynamic(() => import('./Algorithms/Sorting/BogoSort'), {
  loading: Loader,
});
const MergeSortLoader = dynamic(
  () => import('./Algorithms/Sorting/MergeSort'),
  { loading: Loader }
);
const QuickSortLoader = dynamic(
  () => import('./Algorithms/Sorting/QuickSort'),
  { loading: Loader }
);
const HeapSortLoader = dynamic(() => import('./Algorithms/Sorting/HeapSort'), {
  loading: Loader,
});

const BfsPathFindingLoader = dynamic(
  () => import('./Algorithms/PathFinding/Bfs'),
  { loading: Loader }
);
const DfsPathFindingLoader = dynamic(
  () => import('./Algorithms/PathFinding/Dfs'),
  { loading: Loader }
);
const AstarPathFindingLoader = dynamic(
  () => import('./Algorithms/PathFinding/Astar'),
  { loading: Loader }
);

function RenderSubView(
  view: AlgorithmSubView,
  params: SubViewParams
): React.JSX.Element {
  switch (view) {
    case 'home':
      return <HomeLoader {...params} />;
    case 'bubble-sort':
      return <BubbleSortLoader {...params} />;
    case 'bogo-sort':
      return <BogoSortLoader {...params} />;
    case 'merge-sort':
      return <MergeSortLoader {...params} />;
    case 'quick-sort':
      return <QuickSortLoader {...params} />;
    case 'heap-sort':
      return <HeapSortLoader {...params} />;
    case 'bfs':
      return <BfsPathFindingLoader {...params} />;
    case 'dfs':
      return <DfsPathFindingLoader {...params} />;
    case 'astar':
      return <AstarPathFindingLoader {...params} />;
  }
