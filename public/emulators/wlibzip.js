var WLIBZIP = (() => {
  ...
  return function (WLIBZIP = {}) {
    var Module = typeof WLIBZIP != 'undefined' ? WLIBZIP : {};
    ...
    var ___wasm_call_ctors = function () {
      return (___wasm_call_ctors = Module['asm']['C']).apply(null, arguments);
    };
    ...
    var ___errno_location = function () {
      return (___errno_location = Module['asm']['G']).apply(null, arguments);
    };
    ...
    var _zip_from_fs = (Module['_zip_from_fs'] = function () {
      return (_zip_from_fs = Module['_zip_from_fs'] = Module['asm']['I']).apply(
        null,
        arguments
      );
    });
    var _zip_to_fs = (Module['_zip_to_fs'] = function () {
      return (_zip_to_fs = Module['_zip_to_fs'] = Module['asm']['J']).apply(
        null,
        arguments
      );
    });
    ...
    var _zipfile_add = (Module['_zipfile_add'] = function () {
      return (_zipfile_add = Module['_zipfile_add'] = Module['asm']['M']).apply(
        null,
        arguments
      );
    });
    ...
    var ___funcs_on_exit = function () {
      return (___funcs_on_exit = Module['asm']['O']).apply(null, arguments);
    };
    var _fflush = (Module['_fflush'] = function () {
      return (_fflush = Module['_fflush'] = Module['asm']['P']).apply(
        null,
        arguments
      );
    });
    var stackAlloc = function () {
      return (stackAlloc = Module['asm']['Q']).apply(null, arguments);
    };
    var ___start_em_js = (Module['___start_em_js'] = 17972);
    var ___stop_em_js = (Module['___stop_em_js'] = 18244);
    ...
    return WLIBZIP.ready;
  };
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = WLIBZIP;
else if (typeof define === 'function' && define['amd'])
  define([], function () {
    return WLIBZIP;
  });
else if (typeof exports === 'object') exports['WLIBZIP'] = WLIBZIP;
