var WDOSBOXX = (() => {
  ...
  return function (WDOSBOXX = {}) {
    var Module = typeof WDOSBOXX != 'undefined' ? WDOSBOXX : {};
    ...
    function createWasm() {
      ...
      function receiveInstance(instance, module) {
        ...
        Module['asm'] = exports;
        wasmMemory = Module['asm']['Je'];
        updateMemoryViews();
        wasmTable = Module['asm']['Le'];
        addOnInit(Module['asm']['Ke']);
    ...
    function __asyncjs__em_sockdrive_open(url, owner, name, token, jsImpl) {
      return Asyncify.handleAsync(async () => {
        ...
        if (!Module.sockdrive) {
          ...
          Module.sockdrive.onOpen = (drive, read, write) => {
            Module.log(
              'sockdrive: ' + drive + ', read=' + read + ', write=' + write
            );
          };
        ...
        try {
          return await Module.sockdrive.open(
            url,
            owner,
            name,
            token.length > 0 ? token : Module.token
          );
        } catch (e) {
    ...
    function em_sockdrive_read_sync(handle, sector, buffer) {
      return Module.sockdrive.read(handle, sector, buffer, true);
    }
    function __asyncjs__em_sockdrive_read_async(handle, sector, buffer) {
      return Asyncify.handleAsync(async () => {
        return Module.sockdrive.read(handle, sector, buffer, false);
      });
    }
    function sockdrive_write(handle, sector, buffer) {
      return Module.sockdrive.write(handle, sector, buffer);
    }
    function sockdrive_close(handle) {
      Module.sockdrive.close(handle);
    }
    function sockdrive_size(handle) {
      return Module.sockdrive.size(handle);
    }
    function sockdrive_heads(handle) {
      return Module.sockdrive.heads(handle);
    }
    function sockdrive_sectors(handle) {
      return Module.sockdrive.sectors(handle);
    }
    function sockdrive_sector_size(handle) {
      return Module.sockdrive.sector_size(handle);
    }
    function sockdrive_cylinders(handle) {
    ...
    var wasmImports = {
      Qd: __asyncjs__em_sockdrive_open,
      Pd: __asyncjs__em_sockdrive_read_async,
      Ie: ___dlsym,
      He: ___syscall_bind,
      Ge: ___syscall_chdir,
      Fe: ___syscall_chmod,
      Ee: ___syscall_connect,
      De: ___syscall_faccessat,
      d: ___syscall_fcntl64,
      Ce: ___syscall_fstat64,
      qa: ___syscall_ftruncate64,
      Be: ___syscall_getcwd,
      Ae: ___syscall_getdents64,
      $: ___syscall_ioctl,
      ze: ___syscall_listen,
      ye: ___syscall_lstat64,
      xe: ___syscall_mkdirat,
      we: ___syscall_newfstatat,
      _: ___syscall_openat,
      ve: ___syscall_readlinkat,
      ue: ___syscall_recvfrom,
      te: ___syscall_renameat,
      Z: ___syscall_rmdir,
      se: ___syscall_sendto,
      Y: ___syscall_socket,
      re: ___syscall_stat64,
      qe: ___syscall_statfs64,
      X: ___syscall_unlinkat,
      pe: ___syscall_utimensat,
      le: __emscripten_get_now_is_monotonic,
      ke: __gmtime_js,
      je: __localtime_js,
      ie: __mktime_js,
      he: __tzset_js,
      ...
      ee: _eglBindAPI,
      de: _eglChooseConfig,
      ce: _eglCreateContext,
      be: _eglCreateWindowSurface,
      ae: _eglDestroyContext,
      $d: _eglDestroySurface,
      _d: _eglGetConfigAttrib,
      V: _eglGetDisplay,
      Zd: _eglGetError,
      Yd: _eglInitialize,
      Xd: _eglMakeCurrent,
      ...
      Sd: _eglWaitGL,
      Rd: _eglWaitNative,
      Od: em_sockdrive_read_sync,
      Nd: emsc_add_frame_line,
      Md: emsc_end_frame_update,
      U: emsc_exit_runtime,
      Ld: emsc_extract_bundle_to_fs,
      T: emsc_getMTimeMs,
      Kd: emsc_init_backend,
      Jd: emsc_pack_fs_to_bundle,
      Id: emsc_progress,
      Hd: emsc_start_frame_update,
      Gd: emsc_ws_client_frame_set_size,
      Fd: emsc_ws_client_sound_init,
      Ed: emsc_ws_client_sound_push,
      Dd: emsc_ws_exit_runtime,
      f: _emscripten_asm_const_int,
      c: _emscripten_asm_const_int_sync_on_main_thread,
      r: _emscripten_date_now,
      Cd: _emscripten_exit_fullscreen,
      Bd: _emscripten_exit_pointerlock,
      Ad: _emscripten_exit_with_live_runtime,
      S: _emscripten_force_exit,
      ...
      yd: _emscripten_get_screen_size,
      xd: _emscripten_glActiveTexture,
      wd: _emscripten_glAttachShader,
      vd: _emscripten_glBeginQueryEXT,
      ...
      dd: _emscripten_glClearStencil,
      cd: _emscripten_glColorMask,
      bd: _emscripten_glCompileShader,
      ad: _emscripten_glCompressedTexImage2D,
      $c: _emscripten_glCompressedTexSubImage2D,
      _c: _emscripten_glCopyTexImage2D,
      Zc: _emscripten_glCopyTexSubImage2D,
      Yc: _emscripten_glCreateProgram,
      Xc: _emscripten_glCreateShader,
      Wc: _emscripten_glCullFace,
      Vc: _emscripten_glDeleteBuffers,
      Uc: _emscripten_glDeleteFramebuffers,
      Tc: _emscripten_glDeleteProgram,
      Sc: _emscripten_glDeleteQueriesEXT,
      Rc: _emscripten_glDeleteRenderbuffers,
      Qc: _emscripten_glDeleteShader,
      Pc: _emscripten_glDeleteTextures,
      Oc: _emscripten_glDeleteVertexArraysOES,
      Nc: _emscripten_glDepthFunc,
      Mc: _emscripten_glDepthMask,
      Lc: _emscripten_glDepthRangef,
      Kc: _emscripten_glDetachShader,
      Jc: _emscripten_glDisable,
      Ic: _emscripten_glDisableVertexAttribArray,
      Hc: _emscripten_glDrawArrays,
      Gc: _emscripten_glDrawArraysInstancedANGLE,
      Fc: _emscripten_glDrawBuffersWEBGL,
      Ec: _emscripten_glDrawElements,
      Dc: _emscripten_glDrawElementsInstancedANGLE,
      Cc: _emscripten_glEnable,
      Bc: _emscripten_glEnableVertexAttribArray,
      Ac: _emscripten_glEndQueryEXT,
      ...
      tc: _emscripten_glGenFramebuffers,
      sc: _emscripten_glGenQueriesEXT,
      rc: _emscripten_glGenRenderbuffers,
      qc: _emscripten_glGenTextures,
      pc: _emscripten_glGenVertexArraysOES,
      ...
      dc: _emscripten_glGetProgramInfoLog,
      cc: _emscripten_glGetProgramiv,
      bc: _emscripten_glGetQueryObjecti64vEXT,
      ac: _emscripten_glGetQueryObjectivEXT,
      $b: _emscripten_glGetQueryObjectui64vEXT,
      _b: _emscripten_glGetQueryObjectuivEXT,
      Zb: _emscripten_glGetQueryivEXT,
      Yb: _emscripten_glGetRenderbufferParameteriv,
      Xb: _emscripten_glGetShaderInfoLog,
      Wb: _emscripten_glGetShaderPrecisionFormat,
      Vb: _emscripten_glGetShaderSource,
      Ub: _emscripten_glGetShaderiv,
      Tb: _emscripten_glGetString,
      Sb: _emscripten_glGetTexParameterfv,
      Rb: _emscripten_glGetTexParameteriv,
      Qb: _emscripten_glGetUniformLocation,
      Pb: _emscripten_glGetUniformfv,
      Ob: _emscripten_glGetUniformiv,
      Nb: _emscripten_glGetVertexAttribPointerv,
      Mb: _emscripten_glGetVertexAttribfv,
      Lb: _emscripten_glGetVertexAttribiv,
      Kb: _emscripten_glHint,
      Jb: _emscripten_glIsBuffer,
      Ib: _emscripten_glIsEnabled,
      Hb: _emscripten_glIsFramebuffer,
      Gb: _emscripten_glIsProgram,
      Fb: _emscripten_glIsQueryEXT,
      Eb: _emscripten_glIsRenderbuffer,
      Db: _emscripten_glIsShader,
      Cb: _emscripten_glIsTexture,
      Bb: _emscripten_glIsVertexArrayOES,
      Ab: _emscripten_glLineWidth,
      zb: _emscripten_glLinkProgram,
      yb: _emscripten_glPixelStorei,
      xb: _emscripten_glPolygonOffset,
      wb: _emscripten_glQueryCounterEXT,
      ...
      $a: _emscripten_glUniform1iv,
      _a: _emscripten_glUniform2f,
      Za: _emscripten_glUniform2fv,
      Ya: _emscripten_glUniform2i,
      Xa: _emscripten_glUniform2iv,
      Wa: _emscripten_glUniform3f,
      Va: _emscripten_glUniform3fv,
      Ua: _emscripten_glUniform3i,
      Ta: _emscripten_glUniform3iv,
      Sa: _emscripten_glUniform4f,
      Ra: _emscripten_glUniform4fv,
      Qa: _emscripten_glUniform4i,
      Pa: _emscripten_glUniform4iv,
      Oa: _emscripten_glUniformMatrix2fv,
      Na: _emscripten_glUniformMatrix3fv,
      Ma: _emscripten_glUniformMatrix4fv,
      La: _emscripten_glUseProgram,
      Ka: _emscripten_glValidateProgram,
      Ja: _emscripten_glVertexAttrib1f,
      Ia: _emscripten_glVertexAttrib1fv,
      Ha: _emscripten_glVertexAttrib2f,
      Ga: _emscripten_glVertexAttrib2fv,
      Fa: _emscripten_glVertexAttrib3f,
      Ea: _emscripten_glVertexAttrib3fv,
      Da: _emscripten_glVertexAttrib4f,
      Ca: _emscripten_glVertexAttrib4fv,
      Ba: _emscripten_glVertexAttribDivisorANGLE,
      ...
      K: _emscripten_set_keydown_callback_on_thread,
      ...
      G: _emscripten_set_mouseenter_callback_on_thread,
      F: _emscripten_set_mouseleave_callback_on_thread,
      E: _emscripten_set_mousemove_callback_on_thread,
      D: _emscripten_set_mouseup_callback_on_thread,
      C: _emscripten_set_pointerlockchange_callback_on_thread,
      B: _emscripten_set_resize_callback_on_thread,
      ...
      x: _emscripten_set_touchstart_callback_on_thread,
      w: _emscripten_set_visibilitychange_callback_on_thread,
      v: _emscripten_set_wheel_callback_on_thread,
      wa: _emscripten_set_window_title,
      n: _emscripten_sleep,
      oe: _environ_get,
      ne: _environ_sizes_get,
      b: _exit,
      j: _fd_close,
      W: _fd_read,
      pa: _fd_seek,
      ...
      s: _fd_write,
      va: _gethostbyname,
      ua: initMessageSyncSleep,
      ta: initTimeoutSyncSleep,
      sa: isNode,
      ra: isWorker,
      u: now,
      oa: sockdrive_close,
      na: sockdrive_cylinders,
      ma: sockdrive_heads,
      la: sockdrive_sector_size,
      ka: sockdrive_sectors,
      ja: sockdrive_size,
      ia: sockdrive_write,
      t: _strftime,
      ha: _strftime_l,
      ...
      fa: ws_client_error,
      ea: ws_client_log,
      da: ws_client_network_connected,
      k: ws_client_network_disconnected,
      ca: ws_client_stdout,
      ba: ws_client_warn,
      aa: ws_init_runtime,
    };
    ...
    var ___wasm_call_ctors = function () {
      return (___wasm_call_ctors = Module['asm']['Ke']).apply(null, arguments);
    };
    var _free = (Module['_free'] = function () {
      return (_free = Module['_free'] = Module['asm']['Me']).apply(
        null,
        arguments
      );
    });
    var _malloc = (Module['_malloc'] = function () {
      return (_malloc = Module['_malloc'] = Module['asm']['Ne']).apply(
        null,
        arguments
      );
    });
    var ___errno_location = function () {
      return (___errno_location = Module['asm']['Oe']).apply(null, arguments);
    };
    var _fflush = (Module['_fflush'] = function () {
      return (_fflush = Module['_fflush'] = Module['asm']['Pe']).apply(
        null,
        arguments
      );
    });
    var _getAndResetCycles = (Module['_getAndResetCycles'] = function () {
      return (_getAndResetCycles = Module['_getAndResetCycles'] =
        Module['asm']['Qe']).apply(null, arguments);
    });
    var _TriggerEventByName = (Module['_TriggerEventByName'] = function () {
      return (_TriggerEventByName = Module['_TriggerEventByName'] =
        Module['asm']['Re']).apply(null, arguments);
    });
    var _decode_lz4_block = (Module['_decode_lz4_block'] = function () {
      return (_decode_lz4_block = Module['_decode_lz4_block'] =
    ...
    var _zip_to_fs = (Module['_zip_to_fs'] = function () {
      return (_zip_to_fs = Module['_zip_to_fs'] = Module['asm']['Ve']).apply(
        null,
        arguments
      );
    });
    ...
    var _zipfile_add = (Module['_zipfile_add'] = function () {
      return (_zipfile_add = Module['_zipfile_add'] =
    ...
    var _addKey = (Module['_addKey'] = function () {
      return (_addKey = Module['_addKey'] = Module['asm']['bf']).apply(
        null,
        arguments
      );
    });
    var _mouseMove = (Module['_mouseMove'] = function () {
      return (_mouseMove = Module['_mouseMove'] = Module['asm']['cf']).apply(
        null,
        arguments
      );
    });
    ...
    var _mouseSync = (Module['_mouseSync'] = function () {
      return (_mouseSync = Module['_mouseSync'] = Module['asm']['ef']).apply(
        null,
        arguments
      );
    });
    ...
    var _runRuntime = (Module['_runRuntime'] = function () {
      return (_runRuntime = Module['_runRuntime'] = Module['asm']['gf']).apply(
        null,
        arguments
      );
    });
    ...
    var _main = (Module['_main'] = function () {
      return (_main = Module['_main'] = Module['asm']['of']).apply(
        null,
        arguments
      );
    });
    var ___funcs_on_exit = function () {
      return (___funcs_on_exit = Module['asm']['pf']).apply(null, arguments);
    };
    var _htons = function () {
      return (_htons = Module['asm']['qf']).apply(null, arguments);
    };
    var _ntohs = function () {
      return (_ntohs = Module['asm']['rf']).apply(null, arguments);
    };
    var ___trap = function () {
      return (___trap = Module['asm']['sf']).apply(null, arguments);
    };
    ...
    var stackSave = function () {
      return (stackSave = Module['asm']['tf']).apply(null, arguments);
    };
    var stackRestore = function () {
      return (stackRestore = Module['asm']['uf']).apply(null, arguments);
    };
    var stackAlloc = function () {
      return (stackAlloc = Module['asm']['vf']).apply(null, arguments);
    };
    var dynCall_i = (Module['dynCall_i'] = function () {
      return (dynCall_i = Module['dynCall_i'] = Module['asm']['wf']).apply(
        null,
        arguments
      );
    });
    var dynCall_vi = (Module['dynCall_vi'] = function () {
      return (dynCall_vi = Module['dynCall_vi'] = Module['asm']['xf']).apply(
        null,
        arguments
      );
    });
    var dynCall_ii = (Module['dynCall_ii'] = function () {
      return (dynCall_ii = Module['dynCall_ii'] = Module['asm']['yf']).apply(
        null,
        arguments
      );
    });
    var dynCall_vii = (Module['dynCall_vii'] = function () {
      return (dynCall_vii = Module['dynCall_vii'] = Module['asm']['zf']).apply(
        null,
        arguments
      );
    });
    var dynCall_iii = (Module['dynCall_iii'] = function () {
      return (dynCall_iii = Module['dynCall_iii'] = Module['asm']['Af']).apply(
        null,
        arguments
      );
    });
    ...
    var dynCall_v = (Module['dynCall_v'] = function () {
      return (dynCall_v = Module['dynCall_v'] = Module['asm']['Df']).apply(
        null,
        arguments
      );
    });
    ...
    var dynCall_jii = (Module['dynCall_jii'] = function () {
      return (dynCall_jii = Module['dynCall_jii'] = Module['asm']['Hf']).apply(
        null,
        arguments
      );
    });
    ...
    var dynCall_iij = (Module['dynCall_iij'] = function () {
      return (dynCall_iij = Module['dynCall_iij'] = Module['asm']['Lf']).apply(
        null,
        arguments
      );
    });
    var dynCall_ij = (Module['dynCall_ij'] = function () {
      return (dynCall_ij = Module['dynCall_ij'] = Module['asm']['Mf']).apply(
        null,
        arguments
      );
    });
    ...
    var dynCall_ji = (Module['dynCall_ji'] = function () {
      return (dynCall_ji = Module['dynCall_ji'] = Module['asm']['Of']).apply(
        null,
        arguments
      );
    });
    ...
    var dynCall_vf = (Module['dynCall_vf'] = function () {
      return (dynCall_vf = Module['dynCall_vf'] = Module['asm']['Yf']).apply(
        null,
        arguments
      );
    });
    ...
    var dynCall_vff = (Module['dynCall_vff'] = function () {
      return (dynCall_vff = Module['dynCall_vff'] = Module['asm']['_f']).apply(
        null,
        arguments
      );
    });
    var dynCall_vfi = (Module['dynCall_vfi'] = function () {
      return (dynCall_vfi = Module['dynCall_vfi'] = Module['asm']['$f']).apply(
        null,
        arguments
      );
    });
    ...
    var dynCall_vif = (Module['dynCall_vif'] = function () {
      return (dynCall_vif = Module['dynCall_vif'] = Module['asm']['bg']).apply(
        null,
        arguments
      );
    });
    ...
    var _asyncify_start_unwind = function () {
      return (_asyncify_start_unwind = Module['asm']['ng']).apply(
        null,
        arguments
      );
    };
    var _asyncify_stop_unwind = function () {
      return (_asyncify_stop_unwind = Module['asm']['og']).apply(
        null,
        arguments
      );
    };
    var _asyncify_start_rewind = function () {
      return (_asyncify_start_rewind = Module['asm']['pg']).apply(
        null,
        arguments
      );
    };
    var _asyncify_stop_rewind = function () {
      return (_asyncify_stop_rewind = Module['asm']['qg']).apply(
        null,
        arguments
      );
    };
    var ___start_em_js = (Module['___start_em_js'] = 1898844);
    var ___stop_em_js = (Module['___stop_em_js'] = 1915880);
    ...
    return WDOSBOXX.ready;
  };
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = WDOSBOXX;
else if (typeof define === 'function' && define['amd'])
  define([], function () {
    return WDOSBOXX;
  });
else if (typeof exports === 'object') exports['WDOSBOXX'] = WDOSBOXX;
var worker = typeof importScripts === 'function';
