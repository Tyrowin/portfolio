var WDOSBOX = (() => {
  ...
  return function (WDOSBOX = {}) {
    ...
    var wasmImports = {
      ...
      a: _abort,
      T: destroyAsyncify,
      S: emsc_add_frame_line,
      R: emsc_dump_memory_contents,
      Q: emsc_end_frame_update,
      m: emsc_exit_runtime,
      P: emsc_extract_bundle_to_fs,
      l: emsc_getMTimeMs,
      O: emsc_pack_fs_to_bundle,
      N: emsc_progress,
      M: emsc_start_frame_update,
      L: emsc_ws_client_frame_set_size,
      K: emsc_ws_client_sound_init,
      J: emsc_ws_client_sound_push,
      I: emsc_ws_exit_runtime,
    ...
    var ___errno_location = function () {
      return (___errno_location = Module['asm']['ta']).apply(null, arguments);
    };
    var _malloc = (Module['_malloc'] = function () {
      return (_malloc = Module['_malloc'] = Module['asm']['ua']).apply(
        null,
        arguments
      );
    });
    ...
    var _zip_to_fs = (Module['_zip_to_fs'] = function () {
      return (_zip_to_fs = Module['_zip_to_fs'] = Module['asm']['za']).apply(
        null,
        arguments
      );
    });
    ...
    var _addKey = (Module['_addKey'] = function () {
      return (_addKey = Module['_addKey'] = Module['asm']['Ha']).apply(
        null,
        arguments
      );
    });
    var _mouseMove = (Module['_mouseMove'] = function () {
      return (_mouseMove = Module['_mouseMove'] = Module['asm']['Ia']).apply(
        null,
        arguments
      );
    });
    ...
    var _mouseSync = (Module['_mouseSync'] = function () {
      return (_mouseSync = Module['_mouseSync'] = Module['asm']['Ka']).apply(
        null,
        arguments
      );
    });
    ...
    var _runRuntime = (Module['_runRuntime'] = function () {
      return (_runRuntime = Module['_runRuntime'] = Module['asm']['Ma']).apply(
        null,
        arguments
      );
    });
    ...
    var _main = (Module['_main'] = function () {
      return (_main = Module['_main'] = Module['asm']['Ta']).apply(
        null,
        arguments
      );
    });
    var _dumpMemory = (Module['_dumpMemory'] = function () {
      return (_dumpMemory = Module['_dumpMemory'] = Module['asm']['Ua']).apply(
        null,
        arguments
      );
    });
    ...
    var ___funcs_on_exit = function () {
      return (___funcs_on_exit = Module['asm']['Xa']).apply(null, arguments);
    };
    var _fflush = (Module['_fflush'] = function () {
      return (_fflush = Module['_fflush'] = Module['asm']['Ya']).apply(
        null,
        arguments
      );
    });
    var _htons = function () {
      return (_htons = Module['asm']['Za']).apply(null, arguments);
    };
    var _ntohs = function () {
      return (_ntohs = Module['asm']['_a']).apply(null, arguments);
    };
    ...
    var ___cxa_is_pointer_type = function () {
      return (___cxa_is_pointer_type = Module['asm']['ab']).apply(
        null,
        arguments
      );
    };
    var _asyncify_start_unwind = function () {
      return (_asyncify_start_unwind = Module['asm']['bb']).apply(
        null,
        arguments
      );
    };
    var _asyncify_stop_unwind = function () {
      return (_asyncify_stop_unwind = Module['asm']['cb']).apply(
        null,
        arguments
      );
    };
    var _asyncify_start_rewind = function () {
      return (_asyncify_start_rewind = Module['asm']['db']).apply(
        null,
        arguments
      );
    };
    var _asyncify_stop_rewind = function () {
      return (_asyncify_stop_rewind = Module['asm']['eb']).apply(
        null,
        arguments
      );
    };
    var ___start_em_js = (Module['___start_em_js'] = 264096);
    var ___stop_em_js = (Module['___stop_em_js'] = 280538);
