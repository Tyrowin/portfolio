...
})(
  {
        ...
        e.exports = function (t) {
          ...
          return {
                  ...
                  : (function (s, a) {
                      ...
                      function p() {
                        ...
                        ((r.style.cssText = c),
                          ...
                          o.isIE() || (r.data = 'about:blank'),
                          i(s) &&
                            (s.appendChild(r),
                            (i(s).object = r),
                            o.isIE() && (r.data = 'about:blank')));
                      }
                      ((i(s).startSize = { width: d, height: h }),
                        n ? n.add(p) : p());
                    })(s, a));
            },
            addListener: function (t, e) {
              ...
              if (o.isIE(8))
                ((i(t).object = { proxy: n }), t.attachEvent('onresize', n));
              else {
                var r = s(t);
                if (!r)
                  throw new Error(
              ...
              if (i(t)) {
                ...
                e &&
                  (o.isIE(8)
                    ...
                    : t.removeChild(e),
                  i(t).checkForObjectDocumentTimeoutId &&
                    window.clearTimeout(i(t).checkForObjectDocumentTimeoutId),
                  delete i(t).object);
              }
            },
          };
        ...
        e.exports = function (t) {
          ...
          var s = (function () {
              ...
              var i = t - o.clientWidth,
                r = e - o.clientHeight;
              return (document.body.removeChild(o), { width: i, height: r });
            })(),
          ...
          return (
            c(window.document),
            {
              makeDetectable: function (t, c, d) {
                function f() {
                  if (t.debug) {
                    ...
                    if ((n.unshift(r.get(c), 'Scroll: '), e.log.apply))
                      e.log.apply(null, n);
                    else for (var o = 0; o < n.length; o++) e.log(n[o]);
                  }
                }
                function v(t) {
                ...
                function B() {
                  ...
                  if (!t) {
                    ...
                    (l(t, 'animationstart', e), (i(c).onAnimationStart = e));
                  }
                  return t;
                }
                function E() {
                  if ((f('Injecting elements'), i(c))) {
                    !(function () {
                      var n = i(c).style;
                    ...
                    var o,
                      ...
                      _ = u(['position: absolute', 'left: 0', 'top: 0']),
                      w = u([
                        'position: absolute',
                        'width: 200%',
                        'height: 200%',
                    ...
                    ((D.dir = 'ltr'),
                      ...
                      l(E, 'scroll', O),
                      l(K, 'scroll', S),
                      (i(c).onExpandScroll = O),
                      (i(c).onShrinkScroll = S));
                  } else f('Aborting because element has been uninstalled');
                  function O() {
                    var t = i(c);
                    t && t.onExpand
                ...
                function k() {
                  ...
                  function a(o) {
                    var a = c.offsetWidth,
                      l = c.offsetHeight,
                      d = a !== i(c).lastWidth || l !== i(c).lastHeight;
                    (f('Storing current size', a, l),
                      y(c, a, l),
                      n.add(0, function () {
                        if (d)
                          if (i(c))
                  ...
                  function l() {
                    ...
                    var t = i(c);
                    return void 0 === i(c).lastNotifiedWidth &&
                      ...
                      : t.lastWidth === t.lastNotifiedWidth &&
                        ...
                        : (f('Current size not notified, notifying...'),
                          ...
                          void o(i(c).listeners, function (t) {
                            t(c);
                          }));
                  }
                  function d() {
                  ...
                  if (
                    (f('registerListenersAndPositionElements invoked.'), i(c))
                  ) {
                    ((i(c).onRendered = function () {
                      if ((f('startanimation triggered.'), v(c)))
                      ...
                      (i(c).onShrink = d));
                    var g = i(c).style;
                    s(c, g.width, g.height);
                  } else f('Aborting because element has been uninstalled');
                }
                function K() {
                  if ((f('finalizeDomMutation invoked.'), i(c))) {
                    var t = i(c).style;
                    (y(c, t.width, t.height), x(c, t.width, t.height));
                  } else f('Aborting because element has been uninstalled');
                }
                function C() {
                  d(c);
                ...
                function O() {
                  ...
                  (f('Installing...'),
                    (i(c).listeners = []),
                    (t = g()),
                    (i(c).startSize = { width: t.width, height: t.height }),
                    f('Element start size', i(c).startSize),
                    n.add(0, m),
                    n.add(1, E),
                    n.add(2, k),
                    n.add(3, K),
              ...
              uninstall: function (t) {
                var e = i(t);
                e &&
                  (e.onExpandScroll && d(h(t), 'scroll', e.onExpandScroll),
                  e.onShrinkScroll && d(p(t), 'scroll', e.onShrinkScroll),
                  e.onAnimationStart &&
                    d(e.container, 'animationstart', e.onAnimationStart),
    ...
    7: [
      function (t, e, n) {
        ...
        var o = t('./collection-utils').forEach,
          i = t('./element-utils'),
          r = t('./listener-handler'),
          s = t('./id-generator'),
          a = t('./id-handler'),
          c = t('./reporter'),
          u = t('./browser-detector'),
          l = t('batch-processor'),
          d = t('./state-handler'),
          h = t('./detection-strategy/object.js'),
          p = t('./detection-strategy/scroll.js');
        function f(t) {
        ...
        e.exports = function (t) {
          ...
          if ((t = t || {}).idHandler)
            ...
            var n = s(),
              y = a({ idGenerator: n, stateHandler: d });
            e = y;
          }
          var b = t.reporter;
          b || (b = c(!1 === b));
          var _ = m(t, 'batchProcessor', l({ reporter: b })),
            w = {};
          ((w.callOnAdd = !!m(t, 'callOnAdd', !0)),
            (w.debug = !!m(t, 'debug', !1)));
          var D,
            x = r(e),
            B = i({ stateHandler: d }),
            E = m(t, 'strategy', 'object'),
            k = m(t, 'important', !1),
            K = {
              reporter: b,
              batchProcessor: _,
          ...
          return {
            ...
            uninstall: function (t) {
              ...
              o(t, function (t) {
                (x.removeAllListeners(t), D.uninstall(t), d.cleanState(t));
              });
            },
            initDocument: function (t) {
              D.initDocument && D.initDocument(t);
            },
          };
        };
      },
            ...
            return (function (t) {
              ...
              function (t, e, n) {
                ...
                var o,
                  ...
                  s = new Map(),
                  a = function (t) {
                    (s.has(t) && clearTimeout(s.get(t)),
                      s.set(t, setTimeout(t, 100)));
                  },
                  c = function (t, e, n) {
                    for (
                      var o, i = e.split(/[ ,]+/g), r = 0;
                      r < i.length;
                      r += 1
                    )
                      ((o = i[r]),
                  ...
                  _ = { start: 'mousedown', move: 'mousemove', end: 'mouseup' },
                  w = {};
                function D() {}
                (y
                  ? (o = {
                  ...
                  (D.prototype.bindEvt = function (t, e) {
                    var n = this;
                    return (
                      ...
                      c(t, o[e], n._domHandlers_[e]),
                      w[e] && c(t, w[e], n._domHandlers_[e]),
                      n
                    );
                  }),
                  (D.prototype.unbindEvt = function (t, e) {
                    return (
                      (this._domHandlers_ = this._domHandlers_ || {}),
                      u(t, o[e], this._domHandlers_[e]),
                      w[e] && u(t, w[e], this._domHandlers_[e]),
                ...
                ((B.prototype = new x()),
                  (B.constructor = B),
                  (B.id = 0),
                  (B.prototype.buildEl = function (t) {
                    return (
                      (this.ui = {}),
                  ...
                  (B.prototype.stylize = function () {
                    ...
                    var t = this.options.fadeTime + 'ms',
                      e = (function (t, e) {
                        var n = f('borderRadius');
                        for (var o in n) n.hasOwnProperty(o) && (n[o] = '50%');
                        return n;
                      })(),
                      n = p('transition', 'opacity', t),
                      o = {};
                    return (
                      (o.el = {
                        position: 'absolute',
                      ...
                      v(o.el, n),
                      'circle' === this.options.shape && v(o.back, e),
                      v(o.front, e),
                      this.applyStyles(o),
                      this
                    );
                  }),
                  (B.prototype.applyStyles = function (t) {
                  ...
                  (B.prototype.hide = function (t) {
                    ...
                    if (
                      ...
                      var n = e.options.restJoystick,
                        o = {};
                      ((o.x =
                        !0 === n || !1 !== n.x
                          ? 0
                          : e.instance.frontPosition.x),
                        (o.y =
                          !0 === n || !1 !== n.y
                            ? 0
                            : e.instance.frontPosition.y),
                        e.setPosition(t, o));
                    }
                    return e;
                  }),
                  (B.prototype.setPosition = function (t, e) {
                    var n = this;
                  ...
                  (B.prototype.computeDirection = function (t) {
                    var e,
                      n,
                      o,
                      i = t.angle.radian,
                    ...
                    if (
                      ...
                      var u = {};
                      for (a in ((this.direction = { x: n, y: o, angle: e }),
                ...
                function k(t, e) {
                  ...
                  return (
                    n && 'flex' === n.display && (this.parentIsFlex = !0),
                    this.updateBox(),
                    this.prepareNipples(),
                    this.bindings(),
                    this.begin(),
                ...
                ((k.prototype = new x()),
                  ...
                  (k.prototype.createNipple = function (t, e) {
                    var n = this.manager.scroll,
                      o = {},
                      i = this.options,
                      r = this.parentIsFlex ? n.x : n.x + this.box.left,
                      s = this.parentIsFlex ? n.y : n.y + this.box.top;
                    if (t.x && t.y) o = { x: t.x - r, y: t.y - s };
                      ...
                      ((a.style.display = 'hidden'),
                        ...
                        i.zone.appendChild(a));
                      var c = a.getBoundingClientRect();
                      (i.zone.removeChild(a),
                        (o = t),
                        (t = { x: c.left + n.x, y: c.top + n.y }));
                    }
                    var u = new E(this, {
                      color: i.color,
                      size: i.size,
                    ...
                    return (
                      i.dataOnly ||
                        (h(u.ui.el, o), h(u.ui.front, u.frontPosition)),
                      this.nipples.push(u),
                      this.trigger('added ' + u.identifier + ':added', u),
                      this.manager.trigger(
                        'added ' + u.identifier + ':added',
                        u
                      ),
                      this.bindNipple(u),
                      u
                  ...
                  (k.prototype.pressureFn = function (t, e, n) {
                    var o = this,
                      i = 0;
                      ...
                      (o.pressureIntervals[n] = setInterval(
                        function () {
                          ...
                          n !== i &&
                            ...
                            o.trigger(
                              'pressure ' + e.identifier + ':pressure',
                              n
                            ),
                            (i = n));
                        }.bind(o),
                          ...
                          : o.type.match(/^touch/) &&
                            (Object.keys(e.manager.ids).forEach(function (n) {
                              if (
                                ...
                                var i = [t[0]];
                                ((i.identifier = n), e.processOnEnd(i));
                              }
                            }),
                            e.actives.length < n.maxNumberOfNipples &&
                              e.processOnStart(i));
                  ...
                  (k.prototype.processOnStart = function (t) {
                    var e,
                      ...
                      c = n.getOrCreate(r, a);
                    (c.identifier !== r &&
                      n.manager.removeIdentifier(c.identifier),
                      (c.identifier = r));
                    var u = function (e) {
                      (e.trigger('start', e),
                    ...
                    if (
                      ((e = n.idles.indexOf(c)) >= 0 && n.idles.splice(e, 1),
                      n.actives.push(c),
                      ...
                      if (!(i(a, c.position) <= o.catchDistance))
                        return (c.destroy(), void n.processOnStart(t));
                      u(c);
                    }
                    return c;
                  }),
                  (k.prototype.getOrCreate = function (t, e) {
                    var n,
                      o = this.options;
                  ...
                  (k.prototype.processOnMove = function (t) {
                    var e = this.options,
                      n = this.manager.getIdentifier(t),
                      o = this.nipples.get(n),
                    ...
                    if (
                      ...
                      if (e.dynamicPage) {
                        ...
                        o.position = { x: s.x + a.left, y: s.y + a.top };
                      }
                      o.identifier = n;
                      var c = o.options.size / 2,
                        u = { x: t.pageX, y: t.pageY };
                      (e.lockX && (u.y = o.position.y),
                        e.lockY && (u.x = o.position.x));
                      var l,
                        d,
                        p,
                        f,
                      ...
                      if (
                        ('circle' === o.options.shape
                          ? ((v = Math.min(w, c)),
                            ...
                            (_ = { x: 0, y: 0 }),
                            (b = r((b = D))),
                            (_.x = m.x - y * Math.cos(b)),
                            (_.y = m.y - y * Math.sin(b)),
                            (g = _))
                          : ((g = (function (t, e, n) {
                              return {
                        ...
                        if (w > c) {
                          ...
                          ((o.position.x += k),
                            (o.position.y += K),
                            (o.el.style.top =
                              o.position.y - (this.box.top + s.y) + 'px'),
                            (o.el.style.left =
                              o.position.x - (this.box.left + s.x) + 'px'),
                            (w = i(u, o.position)));
                        }
                      } else ((u = g), (w = v));
                      var C = u.x - o.position.x,
                        O = u.y - o.position.y;
                      ((o.frontPosition = { x: C, y: O }),
                        e.dataOnly || h(o.ui.front, o.frontPosition));
                      var S = {
                      ...
                      (((S = o.computeDirection(S)).angle = {
                        radian: r(180 - D),
                        degree: 180 - D,
                      }),
                        o.trigger('move', S),
                        this.trigger('move ' + o.id + ':move', S));
                  ...
                  (k.prototype.processOnEnd = function (t) {
                    ...
                    i &&
                      ...
                      e.ids.indexOf(i.identifier) >= 0 &&
                        e.ids.splice(e.ids.indexOf(i.identifier), 1),
                      e.actives.indexOf(i) >= 0 &&
                        e.actives.splice(e.actives.indexOf(i), 1),
                      /(semi|static)/.test(n.mode)
                        ? e.idles.push(i)
                        : e.nipples.indexOf(i) >= 0 &&
                          e.nipples.splice(e.nipples.indexOf(i), 1),
                      e.manager.unbindDocument(),
                      /(semi|static)/.test(n.mode) &&
                        (e.manager.ids[r.id] = r.identifier));
                  }),
                  (k.prototype.onDestroyed = function (t, e) {
                    (this.nipples.indexOf(e) >= 0 &&
                      this.nipples.splice(this.nipples.indexOf(e), 1),
                      this.actives.indexOf(e) >= 0 &&
                        this.actives.splice(this.actives.indexOf(e), 1),
                      this.idles.indexOf(e) >= 0 &&
                        this.idles.splice(this.idles.indexOf(e), 1),
                      this.ids.indexOf(e.identifier) >= 0 &&
                ...
                ((C.prototype = new x()),
                  ...
                  (C.prototype.createCollection = function (t) {
                    var e = new K(this, t);
                    return (
                      this.bindCollection(e),
                      this.collections.push(e),
                      e
                    );
                  }),
                  (C.prototype.bindCollection = function (t) {
                    var e,
                      n = this,
                      o = function (t, o) {
                        ((e = t.type + ' ' + o.id + ':' + t.type),
                  ...
                  (C.prototype.unbindDocument = function (t) {
                  ...
                  (C.prototype.getIdentifier = function (t) {
                    var e;
                    return (
                      t
                        ? void 0 ===
                  ...
                  (C.prototype.removeIdentifier = function (t) {
                    var e = {};
                  ...
                  (C.prototype.oncancel = function (t) {
                    return (this.onAny('end', t), !1);
                  }),
                  (C.prototype.onAny = function (t, e) {
                    var n,
                      o = this,
                      i = 'processOn' + t.charAt(0).toUpperCase() + t.slice(1);
                    return (
                      (e = l(e)),
                      g(e, function (t) {
                        ((n = o.getIdentifier(t)),
...
***************************************************************************** */
        ...
        (((o = n.NotyfArrayEvent || (n.NotyfArrayEvent = {}))[(o.Add = 0)] =
          'Add'),
          (o[(o.Remove = 1)] = 'Remove'));
        var s,
          a = (function () {
            ...
            return (
              (t.prototype.push = function (t) {
                (this.notifications.push(t),
                  this.updateFn(t, n.NotyfArrayEvent.Add, this.notifications));
              }),
              (t.prototype.splice = function (t, e) {
                var o = this.notifications.splice(t, e)[0];
                return (
                  this.updateFn(
                    o,
                    n.NotyfArrayEvent.Remove,
                    this.notifications
                  ),
                  o
                );
        ...
        (((s = n.NotyfEvent || (n.NotyfEvent = {})).Dismiss = 'dismiss'),
          (s.Click = 'click'));
        var c = {
            types: [
              {
          ...
          u = (function () {
            ...
            return (
              (t.prototype.on = function (t, e) {
                var n;
                this.events = i(i({}, this.events), (((n = {})[t] = e), n));
              }),
              (t.prototype.update = function (t, e) {
                e === n.NotyfArrayEvent.Add
                  ? this.addNotification(t)
                  : e === n.NotyfArrayEvent.Remove &&
              ...
              (t.prototype.removeNotification = function (t) {
                ...
                i &&
                  ((e = i.node).classList.add('notyf__toast--disappear'),
                  e.addEventListener(
              ...
              (t.prototype._buildNotificationCard = function (t) {
                var e = this,
                  o = t.options,
                  i = o.icon;
                this.adjustContainerAlignment(o);
                ...
                var u = o.background || o.backgroundColor;
                if (i) {
                  ...
                  if (
                    (('string' == typeof i || i instanceof String) &&
                      (l.innerHTML = new String(i).valueOf()),
                    'object' == typeof i)
                  ) {
                    var d = i.tagName,
                      h = void 0 === d ? 'i' : d,
                      ...
                      v = i.color,
                      g = void 0 === v ? u : v,
                      m = this._createHTMLElement({
                        tagName: h,
                        className: p,
                        text: f,
                      });
                    (g && (m.style.color = g), l.appendChild(m));
                  }
                  a.appendChild(l);
                }
                if (
                  ...
                  u &&
                    (o.ripple
                      ? ((s.style.background = u), r.appendChild(s))
                      : (r.style.background = u)),
                  o.dismissible)
                ) {
                  var y = this._createHTMLElement({
                      tagName: 'div',
                      className: 'notyf__dismiss',
                    }),
                    b = this._createHTMLElement({
                      tagName: 'button',
                      className: 'notyf__dismiss-btn',
                    });
                  (y.appendChild(b),
                    a.appendChild(y),
                    r.classList.add('notyf__toast--dismissible'),
                    b.addEventListener('click', function (o) {
                      var i, r;
                      (null === (r = (i = e.events)[n.NotyfEvent.Dismiss]) ||
                        void 0 === r ||
                        r.call(i, { target: t, event: o }),
                        o.stopPropagation());
                    }));
                }
                r.addEventListener('click', function (o) {
                  var i, r;
                  return null === (r = (i = e.events)[n.NotyfEvent.Click]) ||
                    void 0 === r
                    ? void 0
                    : r.call(i, { target: t, event: o });
                });
                var _ = 'top' === this.getYPosition(o) ? 'upper' : 'lower';
                return (r.classList.add('notyf__toast--' + _), r);
              }),
              (t.prototype._createHTMLElement = function (t) {
                ...
                return (n && (i.className = n), (i.textContent = o || null), i);
              }),
          ...
          l = (function () {
            function t(t) {
              ...
              ((this.dismiss = this._removeNotification),
                ...
                (this.view = new u()));
              var o = this.registerTypes(t);
              ((this.options = i(i({}, c), t)),
                (this.options.types = o),
                this.notifications.onUpdate(function (t, n) {
                  return e.view.update(t, n);
                }),
                this.view.on(n.NotyfEvent.Dismiss, function (t) {
                  var o = t.target,
                    i = t.event;
                  (e._removeNotification(o),
                    o.triggerEvent(n.NotyfEvent.Dismiss, i));
                }),
                this.view.on(n.NotyfEvent.Click, function (t) {
                  var e = t.target,
                    o = t.event;
                  return e.triggerEvent(n.NotyfEvent.Click, o);
                }));
            }
            return (
            ...
            return (function () {
              var t = {
                  ...
                  9483: function (t, e, n) {
                    ...
                    t.exports = function (t) {
                      if (o(t)) return t;
                      throw r(i(t) + ' is not a constructor');
                    };
                  },
                  6077: function (t, e, n) {
                    var o = n(614),
                    ...
                    t.exports = function (t) {
                      ...
                      throw r("Can't set " + i(t) + ' as a prototype');
                    };
                  },
                  1223: function (t, e, n) {
                    var o = n(5112),
                      ...
                      a = Array.prototype;
                    (null == a[s] &&
                      r(a, s, { configurable: !0, value: i(null) }),
                      (t.exports = function (t) {
                        a[s][t] = !0;
                      }));
                  },
                  ...
                  8457: function (t, e, n) {
                    ...
                    t.exports = function (t) {
                      var e = r(t),
                        ...
                        g = void 0 !== v;
                      g && (v = o(v, f > 2 ? arguments[2] : void 0));
                      var m,
                        y,
                        b,
                        _,
                        ...
                        B = 0;
                      if (!x || (this === p && a(x)))
                        for (m = u(e), y = n ? new this(m) : p(m); m > B; B++)
                          ((D = g ? v(e[B], B) : e[B]), l(y, B, D));
                      else
                        for (
                          w = (_ = d(e, x)).next, y = n ? new this() : [];
                          !(b = i(w, _)).done;
                          B++
                        )
                          ((D = g ? s(_, v, [b.value, B], !0) : b.value),
                            l(y, B, D));
                      return ((y.length = B), y);
                    };
                  },
                        ...
                        return function (f, v, g, m) {
                          for (
                            var y,
                              ...
                              B = 0,
                              E = m || c,
                              k = e ? E(f, x) : n || h ? E(f, 0) : void 0;
                            x > B;
                            B++
                          )
                            if ((p || B in w) && ((b = D((y = w[B]), B, _)), t))
                              if (e) k[B] = b;
                              else if (b)
                                switch (t) {
                                  case 3:
                  ...
                  4362: function (t, e, n) {
                    var o = n(1589),
                      ...
                      r = function (t, e) {
                        ...
                        return n < 8
                          ? s(t, e)
                          : a(t, r(o(t, 0, c), e), r(o(t, c), e), e);
                      },
                      s = function (t, e) {
                        for (var n, o, i = t.length, r = 1; r < i; ) {
                          for (o = r, n = t[r]; o && e(t[o - 1], n) > 0; )
                            t[o] = t[--o];
                          o !== r++ && (t[o] = n);
                        }
                        return t;
                      ...
                      a = function (t, e, n, o) {
                        for (
                          var i = e.length, r = n.length, s = 0, a = 0;
                          s < i || a < r;
                  ...
                  9920: function (t, e, n) {
                    ...
                    t.exports = function (t, e, n) {
                      for (
                        var a = i(e), c = s.f, u = r.f, l = 0;
                        l < a.length;
                        l++
                      ) {
                        var d = a[l];
                        o(t, d) || (n && o(n, d)) || c(t, d, u(e, d));
                      }
                    };
                  },
                  4964: function (t, e, n) {
                  ...
                  654: function (t, e, n) {
                    ...
                    t.exports = function (t, e, n, s, f, g, k) {
                      c(n, e, s);
                      var K,
                        C,
                        O,
                        ...
                        T = !1,
                        M = t.prototype,
                        I = M[w] || M['@@iterator'] || (f && M[f]),
                        L = (!_ && I) || S(f),
                        N = ('Array' == e && M.entries) || I;
                      if (
                        (N &&
                          (K = u(N.call(new t()))) !== Object.prototype &&
                          K.next &&
                          (r ||
                            u(K) === b ||
                            (l ? l(K, b) : a(K[w]) || p(K, w, E)),
                          d(K, P, !0, !0),
                          r && (v[P] = E)),
                        m &&
                          f == x &&
                        ...
                        if (
                          ...
                          for (O in C) (_ || T || !(O in M)) && p(M, O, C[O]);
                        else o({ target: e, proto: !0, forced: _ || T }, C);
                      return (
                        (r && !k) || M[w] === L || p(M, w, L, { name: f }),
                        (v[e] = L),
                        C
                      );
                    };
                  ...
                  5117: function (t, e, n) {
                    ...
                    t.exports = function (t, e) {
                      if (!delete t[e])
                        throw i(
                          'Cannot delete property ' + o(e) + ' of ' + o(t)
                        );
                    };
                  },
                  9781: function (t, e, n) {
                  ...
                  1246: function (t, e, n) {
                    ...
                    t.exports = function (t) {
                      if (null != t)
                        return i(t, s) || i(t, '@@iterator') || r[o(t)];
                    };
                  },
                  8554: function (t, e, n) {
                    var o = n(6916),
                  ...
                  647: function (t, e, n) {
                    var o = n(1702),
                      ...
                      u = /\$([$&'`]|\d{1,2}|<[^>]*>)/g,
                      l = /\$([$&'`]|\d{1,2})/g;
                    t.exports = function (t, e, n, o, d, h) {
                      var p = n + t.length,
                        f = o.length,
                        v = l;
                      return (
                  ...
                  6339: function (t, e, n) {
                    var o = n(7293),
                      ...
                      v = (t.exports = function (t, e, n) {
                        ...
                        return (
                          r(o, 'source') ||
                            (o.source = f.join('string' == typeof e ? e : '')),
                          t
                        );
                      });
                  ...
                  8536: function (t, e, n) {
                    var o = n(7854),
                      ...
                      r = n(2788),
                      s = o.WeakMap;
                    t.exports = i(s) && /native code/.test(r(s));
                  },
                  3929: function (t, e, n) {
                    var o = n(7850),
                      i = TypeError;
                    ...
                    e.f =
                      o && !i
                        ...
                        : function (t, e) {
                            s(t);
                            for (
                              var n, o = a(e), i = c(e), u = i.length, l = 0;
                              u > l;
                  ...
                  1236: function (t, e, n) {
                    ...
                    e.f = o
                      ...
                      : function (t, e) {
                          ...
                          if (u(t, e)) return s(!i(r.f, t, e), t[e]);
                        };
                  },
                  1156: function (t, e, n) {
                    var o = n(4326),
                  ...
                  6324: function (t, e, n) {
                    ...
                    t.exports = function (t, e) {
                      var n,
                        ...
                        u = 0,
                        l = [];
                      for (n in o) !i(a, n) && i(o, n) && c(l, n);
                      for (; e.length > u; )
                        i(o, (n = e[u++])) && (~s(l, n) || c(l, n));
                      return l;
                    };
                  },
                  1956: function (t, e, n) {
                    ...
                    ((D || B || x || p || f) &&
                      (m = function (t) {
                        ...
                        if (
                          ...
                          for (i.groups = u = d(null), s = 0; s < K.length; s++)
                            u[(l = K[s])[0]] = i[l[1]];
                        return i;
                      }),
                      (t.exports = m));
                  ...
                  2309: function (t, e, n) {
                    ...
                    (t.exports = function (t, e) {
                      ...
                      license:
                        'https://github.com/zloirock/core-js/blob/v3.23.5/LICENSE',
                    ...
                    o(
                      { target: 'Array', proto: !0, forced: c || !u },
                      {
                        indexOf: function (t) {
                          ...
                          return c ? a(this, t, e) || 0 : r(this, t, e);
                        },
                      }
                    );
                  },
                  6992: function (t, e, n) {
                    ...
                    t.exports = c(
                      ...
                      'Array',
                      function (t, e) {
                        h(this, { type: d, target: o(t), index: 0, kind: e });
                      },
                      function () {
                        var t = p(this),
                          e = t.target,
                      ...
                      { target: 'Array', proto: !0, forced: !f },
                      {
                        slice: function (t, e) {
                          ...
                          if (
                            ...
                            return p(h, y, b);
                          for (
                            o = new (void 0 === n ? g : n)(m(b - y, 0)), d = 0;
                            y < b;
                            y++, d++
                          )
                            y in h && l(o, d, h[y]);
                      ...
                      { target: 'Array', proto: !0, forced: !h },
                      {
                        splice: function (t, e) {
                          ...
                          for (
                            ...
                            (g = _ + v) in y && l(h, v, y[g]);
                          if (((h.length = o), n < o)) {
                            for (v = _; v < b - o; v++)
                              ((m = v + n),
                                (g = v + o) in y ? (y[m] = y[g]) : d(y, m));
                            for (v = b; v > b - o + n; v--) d(y, v - 1);
                          } else if (n > o)
                            for (v = b - o; v > _; v--)
                              ((m = v + n - 1),
                                (g = v + o - 1) in y ? (y[m] = y[g]) : d(y, m));
                          for (v = 0; v < n; v++) y[v + _] = arguments[v + 2];
                          return ((y.length = b - o + n), h);
                        },
                      }
                    );
                  },
                  ...
                  8862: function (t, e, n) {
                    var o = n(2109),
                      ...
                      K = function (t, e, n) {
                        var o = m(n, e - 1),
                          i = m(n, e + 1);
                        return (g(D, t) && !g(x, i)) || (g(x, t) && !g(D, o))
                          ? '\\u' + _(y(t, 0), 16)
                          : t;
                      };
                    v &&
                      o(
                        { target: 'JSON', stat: !0, arity: 3, forced: B || E },
                        {
                          stringify: function (t, e, n) {
                            var o = p(arguments),
                              i = r(B ? k : v, null, o);
                            return E && 'string' == typeof i ? b(i, w, K) : i;
                          },
                        }
                      );
                  },
                  9653: function (t, e, n) {
                    ...
                    var o = n(9781),
                      ...
                      k = function (t) {
                        ...
                        if ('string' == typeof u && u.length > 2)
                          if (((u = y(u)), 43 === (e = B(u, 0)) || 45 === e)) {
                            if (88 === (n = B(u, 2)) || 120 === n) return NaN;
                          } else if (48 === e) {
                            switch (B(u, 1)) {
                              case 66:
                              case 98:
                            ...
                            for (s = (r = x(u, 2)).length, a = 0; a < s; a++)
                              if ((c = B(r, a)) < 48 || c > i) return NaN;
                            return parseInt(r, o);
                          }
                        return +u;
                      };
                    if (s(b, !_(' 0o1') || !_('0b1') || _('+0x1'))) {
                      for (
                        ...
                        c(_, (K = O[S])) && !c(C, K) && g(C, K, v(_, K));
                      ((C.prototype = w),
                        (w.constructor = C),
                        a(i, b, C, { constructor: !0 }));
                    }
                  },
                  3161: function (t, e, n) {
                    n(2109)(
                  ...
                  9595: function (t, e, n) {
                    ...
                    i &&
                      o(
                        { target: 'Object', proto: !0, forced: r },
                        {
                      ...
                      for (
                        var F = function (t, e) {
                            var n,
                              ...
                              m = [],
                              _ = t;
                            if (!f && v && g && t.constructor === F) return t;
                            if (
                              ((v || l(k, t)) &&
                                ((t = t.source), g && (e = p(_))),
                              (t = void 0 === t ? '' : h(t)),
                    ...
                    i('match', function (t, e, n) {
                      return [
                        function (e) {
                          ...
                          return i ? o(i, e, n) : new RegExp(e)[t](a(n));
                        },
                        function (t) {
                          var o = r(this),
                            i = a(t),
                          ...
                          if (!o.global) return d(o, i);
                          var u = o.unicode;
                          o.lastIndex = 0;
                          for (var h, p = [], f = 0; null !== (h = d(o, i)); ) {
                            var v = a(h[0]);
                            ((p[f] = v),
                              '' === v &&
                                (o.lastIndex = l(i, s(o.lastIndex), u)),
                              f++);
                          }
                          return 0 === f ? null : p;
                        },
                    ...
                    s(
                      ...
                      function (t, e, n) {
                        ...
                        return [
                          function (t, n) {
                            var o = p(this),
                              r = null == t ? void 0 : v(t, y);
                            return r ? i(r, t, o, n) : i(e, h(o), t, n);
                          },
                          function (t, i) {
                            var s = c(this),
                              a = h(t);
                            ...
                            for (var k = []; ; ) {
                              ...
                              if ((D(k, K), !y)) break;
                              '' === h(K[0]) &&
                                (s.lastIndex = f(a, d(s.lastIndex), E));
                            }
                            for (
                              var C, O = '', S = 0, P = 0;
                              P < k.length;
                              ...
                              for (
                                var T = h((K = k[P])[0]),
                                  M = b(_(l(K.index), a.length), 0),
                                  I = [],
                                  L = 1;
                                L < K.length;
                                L++
                              )
                                D(I, void 0 === (C = K[L]) ? C : String(C));
                              var N = K.groups;
                              if (v) {
                                var A = w([T], I, M, a);
                                void 0 !== N && D(A, N);
                                var j = h(o(i, void 0, A));
                              } else j = g(T, a, M, I, N, i);
                              M >= S &&
                                ((O += B(a, S, M) + j), (S = M + T.length));
                            }
                            return O + B(a, S);
                          },
                        ];
                      ...
                      function (t, e, n) {
                        ...
                        return (
                          ...
                          [
                            function (e, n) {
                              var o = u(this),
                                s = null == e ? void 0 : f(e, t);
                              return s ? i(s, e, o, n) : i(r, p(o), e, n);
                            },
                            function (t, o) {
                              var i = c(this),
                                s = p(t),
                              ...
                              var u = l(i, RegExp),
                                ...
                                v =
                                  ...
                                  (i.unicode ? 'u' : '') +
                                  (_ ? 'g' : 'y'),
                                m = new u(_ ? '^(?:' + i.source + ')' : i, v),
                                y = void 0 === o ? w : o >>> 0;
                              if (0 === y) return [];
                              if (0 === s.length)
                                return null === g(m, s) ? [s] : [];
                              for (var b = 0, x = 0, B = []; x < s.length; ) {
                                m.lastIndex = _ ? 0 : x;
                                var K,
                                  C = g(m, _ ? k(s, x) : s);
                                if (
                                  ...
                                  if ((E(B, k(s, b, x)), B.length === y))
                                    return B;
                                  for (var O = 1; O <= C.length - 1; O++)
                                    if ((E(B, C[O]), B.length === y)) return B;
                                  x = b = K;
                                }
                              }
                              return (E(B, k(s, b)), B);
                  ...
                  4032: function (t, e, n) {
                    ...
                    var o = n(2109),
                      ...
                      it = function (t, e) {
                        var n = (Z[t] = y(G));
                        return (
                          z(n, { type: R, tag: t, description: e }),
                          c || (n.description = e),
                          n
                        );
                      },
                    ...
                    (u ||
                      (K(
                        (G = (V = function () {
                          ...
                          return (
                            c && nt && ot(U, e, { configurable: !0, set: n }),
                            it(e, t)
                          );
                        }).prototype),
                        'toString',
                      ...
                      c &&
                        ...
                        a || K(U, 'propertyIsEnumerable', at, { unsafe: !0 }))),
                      o(
                        {
                          global: !0,
                          constructor: !0,
                  ...
                  1817: function (t, e, n) {
                    ...
                    if (
                      i &&
                      c(p) &&
                      (!('description' in f) || void 0 !== p().description)
                    ) {
                      var v = {},
                        g = function () {
                          var t =
                      ...
                      (h(g, p), (g.prototype = f), (f.constructor = g));
                  ...
                  6620: function (t, e, n) {
                    ...
                    o(
                      ...
                      {
                        keyFor: function (t) {
                          if (!r(t)) throw TypeError(s(t) + ' is not a symbol');
                          if (i(u, t)) return u[t];
                        },
                      }
                    );
                  ...
                  4747: function (t, e, n) {
                    ...
                    for (var u in i) i[u] && c(o[u] && o[u].prototype);
                    c(r);
                  },
                  3948: function (t, e, n) {
                    var o = n(7854),
                    ...
                    for (var p in i) h(o[p] && o[p].prototype, p);
                    h(r, 'DOMTokenList');
                  },
                },
                e = {};
                  ...
                  var c = (function () {
                    function n(t) {
                      ...
                      (!(function (t, e) {
                        ...
                        a(this, 'isStandardButton', function (t) {
                          return (
                            t && !('{' === t[0] && '}' === t[t.length - 1])
                          );
                        }),
                      ...
                      (i = [
                        ...
                        },
                        {
                          ...
                          value: function (t, e) {
                            ...
                            return (
                              o || 0 === o
                                ? ((n = [t.slice(0, o), e, t.slice(i)].join(
                                    ''
                                  )),
                                  this.isMaxLengthReached() ||
                                    (r && this.updateCaretPos(e.length)))
                                : (n = t + e),
                              n
                            );
                          },
                        },
                        {
                          ...
                          value: function (t) {
                            ...
                            if (n === o) {
                              var r = /([\uD800-\uDBFF][\uDC00-\uDFFF])/g;
                              n && n >= 0
                                ? t.substring(n - 2, n).match(r)
                                  ? ((e = t.substr(0, n - 2) + t.substr(n)),
                                    i && this.updateCaretPos(2, !0))
                                  : ((e = t.substr(0, n - 1) + t.substr(n)),
                                    i && this.updateCaretPos(1, !0))
                                : t.slice(-2).match(r)
                                  ? ((e = t.slice(0, -2)),
                                    i && this.updateCaretPos(2, !0))
                                  : ((e = t.slice(0, -1)),
                        ...
                        },
                        {
                          ...
                          value: function (t, e) {
                            var n = this.getOptions(),
                              o = n.maxLength,
                              i = t[n.inputName || 'default'],
                              s = e.length - 1 >= o;
                            if (e.length <= i.length) return !1;
                            if (Number.isInteger(o))
                              return (
                                n.debug &&
                                  console.log('maxLength (num) reached:', s),
                                s
                        ...
                        },
                        {
                          key: 'chunkArray',
                          value: function (e, n) {
                            return t(Array(Math.ceil(e.length / n))).map(
                              function (t, o) {
                      ...
                      (n = [
                        {
                          ...
                          value: function (t) {
                            ...
                            this.dispatch(function (o) {
                              var i,
                                r,
                                s = o.getButtonElement(n),
                                a = o.getButtonElement('{'.concat(n, '}'));
                              if (s) ((i = s), (r = n));
                              else {
                                if (!a) return;
                                ((i = a), (r = '{'.concat(n, '}')));
                      ...
                      (n = [
                        ...
                        },
                        {
                          ...
                          value: function (t) {
                            var e = this,
                              ...
                              i = t.onSelect;
                            if (n && n.length) {
                              var r = this.utilities.chunkArray(
                                n.split(' '),
                                this.pageSize
                              );
                              this.renderPage({
                        ...
                        },
                        {
                          ...
                          value: function (t) {
                            ...
                            ((c.className = 'hg-candidate-box-list'),
                            ...
                            (l.classList.add('hg-candidate-box-prev'),
                              u &&
                                l.classList.add('hg-candidate-box-btn-active'),
                              (l.onclick = function () {
                                u &&
                                  n.renderPage({
                              ...
                              this.candidateBoxElement.appendChild(c));
                            var d = r < s - 1,
                              h = document.createElement('div');
                            (h.classList.add('hg-candidate-box-next'),
                              d &&
                                h.classList.add('hg-candidate-box-btn-active'),
                              (h.onclick = function () {
                                d &&
                                  n.renderPage({
                                    candidateListPages: o,
                              ...
                              this.candidateBoxElement.appendChild(h),
                              i.prepend(this.candidateBoxElement));
                          },
                        },
                      ]) && h(e.prototype, n),
                      Object.defineProperty(e, 'prototype', { writable: !1 }),
                  ...
                  var _ = (function () {
                    function t(e, n) {
                      ...
                      if (
                        ...
                        var i = this.handleParams(e, n),
                          r = i.keyboardDOMClass,
                          s = i.keyboardDOM,
                          a = i.options,
                          c = void 0 === a ? {} : a;
                        ((this.utilities = new u({
                        ...
                        var l = this.options.inputName,
                          h = void 0 === l ? this.defaultName : l;
                        if (
                          ((this.input = {}),
                          (this.input[h] = ''),
                          (this.keyboardDOMClass = r),
                          (this.buttonElements = {}),
                          ...
                          throw (
                            console.warn(
                              '".'.concat(r, '" was not found in the DOM.')
                            ),
                      ...
                      (n = [
                        ...
                        },
                        {
                          ...
                          value: function (t) {
                            ...
                            if (!o || 'object' !== g(o)) return {};
                            var r = Object.keys(o).filter(function (n) {
                              var o =
                                  t.substring(
                                    0,
                                    e.getCaretPositionEnd() || 0
                                  ) || t,
                                r = new RegExp(
                                  ''.concat(n, '$'),
                                  i ? 'g' : 'gi'
                                );
                              return !!f(o.matchAll(r)).length;
                            });
                            if (r.length > 1) {
                              ...
                              this.candidateBox.show({
                                ...
                                onSelect: function (e, n) {
                                  var i =
                                    ...
                                    r = e.normalize('NFD'),
                                    s = o.getInput(o.options.inputName, !0),
                                    a = o.getCaretPositionEnd() || 0,
                                    c = s.substring(0, a || 0) || s,
                                    u = new RegExp(
                                      ''.concat(t, '$'),
                                      i ? 'g' : 'gi'
                                    ),
                                    ...
                                    p = (a || s.length) + h;
                                  (p < 0 && (p = 0),
                                    o.setInput(d, o.options.inputName, !0),
                                    o.setCaretPosition(p),
                              ...
                              if (
                                ...
                                this.input[i] !== s &&
                                  (!this.options.inputPattern ||
                                    (this.options.inputPattern &&
                                      this.inputPatternIsValid(s))))
                              ) {
                                if (
                                  this.options.maxLength &&
                                  this.utilities.handleMaxLength(this.input, s)
                                )
                                  return;
                                ...
                                if (
                                  ...
                                  l && d
                                    ...
                                    : null === (c = this.candidateBox) ||
                                      void 0 === c ||
                                      c.destroy();
                                }
                              }
                              r && console.log('Key pressed:', t);
                            }
                          },
                        },
                        {
                            ...
                            return (
                              r.length &&
                                n.forEach(function (n, a) {
                                  ...
                                  var h = ''
                                    .concat(i.options.layoutName, '-r')
                                    .concat(e, 'c')
                                    .concat(a);
                                  d.setAttribute('data-skUID', h);
                                  var p = r.splice(u, l - u + 1);
                                  ((s = l - u),
                            ...
                            ((this.keyboardDOM.className =
                              ...
                              n[
                                ...
                                (i.forEach(function (e, i) {
                                  ...
                                  (d && (c.push(i), (e = e.replace(/\[/g, ''))),
                                    h &&
                                      (u.push(i), (e = e.replace(/\]/g, ''))));
                                  var p = t.utilities.getButtonClass(e),
                                    ...
                                    g = t.options.useButtonTag
                                      ? 'button'
                                      : 'div',
                                    m = document.createElement(g);
                                  ((m.className += 'hg-button '.concat(p)),
                                    (l = m.classList).add.apply(
                                      l,
                                      f(t.getButtonThemeClasses(e))
                                    ),
                                    ...
                                    !t.utilities.pointerEventsSupported() ||
                                    o ||
                                    r
                                      ? o
                                        ? ((m.ontouchstart = function (n) {
                                      ...
                                      : ((m.onpointerdown = function (n) {
                                        ...
                                        (m.onpointerup = function (n) {
                                          t.handleButtonMouseUp(e, n);
                                        }),
                                        (m.onpointercancel = function (n) {
                                          t.handleButtonMouseUp(e, n);
                                        })),
                                  ...
                                  var y = ''
                                    ...
                                    .concat(n, 'b')
                                    .concat(i);
                                  m.setAttribute('data-skBtnUID', y);
                                  var b = document.createElement('span');
                                  ((b.innerHTML = v),
                                    m.appendChild(b),
                                    t.buttonElements[e] ||
                                      (t.buttonElements[e] = []),
                                    t.buttonElements[e].push(m),
                                    a.appendChild(m));
                                }),
                                  (a = t.parseRowDOMContainers(a, n, c, u)),
                                  t.keyboardRowsDOM.appendChild(a));
                              }),
                                  ...
                                  ? o
                                    ? ((document.ontouchend = function (e) {
                                      ...
                                      (this.keyboardDOM.ontouchstart =
                                        function (e) {
                                          return t.handleKeyboardContainerMouseDown(
                                            e
                                          );
                                        }))
                                    : o ||
    ...
    18: [
      function (t, e, n) {
        'use strict';
        (Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.deprecatedButton = n.createButton = void 0));
        const o = t('../dom/keys'),
          i = t('../dom/pointer'),
          r = (function () {
            const t = {};
            for (const e of Object.keys(o.namedKeyCodes))
              t[o.namedKeyCodes[e]] = e.substr(4, 2);
            return t;
          })();
        function s(t, e, n) {
          const o = Math.round(0.6 * n),
            ...
            c = f[t.toLowerCase()],
            u = void 0 === c ? t : '',
            l = a('emulator-button-touch-zone'),
            d = a('emulator-button'),
            h = a(
              ...
              void 0 === c
                ? void 0 === u || 0 === u.length
                  ? '□'
                  : u.substr(0, 1).toUpperCase()
                : ''
            );
          (void 0 !== c && (d.style.backgroundImage = 'url("' + c + '")'),
            (d.style.width = o + 'px'),
            (d.style.height = o + 'px'),
            (h.style.fontSize = r + 'px'),
            (l.widthPx = n - 2 * s),
            (l.heightPx = n - 2 * s),
            (l.style.width = l.widthPx + 'px'),
            (l.style.height = l.heightPx + 'px'),
            (l.style.borderWidth = s + 'px'),
            l.appendChild(d),
            l.appendChild(h));
          const p = t => {
            ...
            m = { capture: !0 };
          for (const t of i.pointer.starters) l.addEventListener(t, p, m);
          for (const t of i.pointer.enders) l.addEventListener(t, v, m);
          for (const t of i.pointer.changers) l.addEventListener(t, g, m);
          for (const t of i.pointer.leavers) l.addEventListener(t, g, m);
          for (const t of i.pointer.prevents) l.addEventListener(t, g, m);
          return l;
        }
        function a(t, e) {
        ...
        function c(t) {
          return 'number' == typeof t ? r[t] : t;
        }
        function u(t, e) {
          return 'click' === t.action
            ? { onClick: () => e.fireKeyPress(t.mapTo) }
            : {
                onDown: () => e.fireKeyDown(t.mapTo),
                onUp: () => e.fireKeyUp(t.mapTo),
              };
        }
        ((n.createButton = s),
          (n.deprecatedButton = function (t, e, n, i) {
            const r = Math.round(i / 4),
              a = [];
            for (const e of n) {
              if (e.mapTo === o.KBD_NONE) continue;
              const n = s((e.symbol || c(e.mapTo)).toUpperCase(), u(e, t), i);
              n.style.position = 'absolute';
              const l = e.style;
              if (l) for (const t of Object.keys(l)) n.style[t] = l[t];
              if (void 0 !== e.position) {
                const t = e.position.left,
                  o = e.position.top,
                  s = e.position.bottom,
                  a = e.position.right;
                (void 0 !== t && (n.style.left = r * t + i * (t - 1) + 'px'),
                  void 0 !== a && (n.style.right = r * a + i * (a - 1) + 'px'),
                  void 0 !== o && (n.style.top = r * o + i * (o - 1) + 'px'),
                  void 0 !== s &&
                    (n.style.bottom = r * s + i * (s - 1) + 'px'));
              }
              (t.mouseOverlay.appendChild(n), a.push(n));
            }
            return () => {
              for (const e of a)
                e.parentElement === t.mouseOverlay &&
                  t.mouseOverlay.removeChild(e);
            };
          }));
        const l =
      ...
      function (t, e, n) {
        ...
        (Object.defineProperty(n, '__esModule', { value: !0 }),
          ...
          (n.keyboard = function (t, e, n) {
            ...
            return (
              t.setOnKeyDown(t => {
                e.sendKeyEvent(i(t), !0);
              }),
              t.setOnKeyUp(t => {
                e.sendKeyEvent(i(t), !1);
              }),
              t.setOnKeyPress(t => {
                e.simulateKeyPress(i(t));
              }),
              t.setOnKeysPress(t => {
                e.simulateKeyPress(...t);
              }),
              () => {
                (t.setOnKeyDown(t => {}),
                  t.setOnKeyUp(t => {}),
    ...
    21: [
      function (t, e, n) {
        ...
        (Object.defineProperty(n, '__esModule', { value: !0 }),
          ...
          (n.extractLayersConfig = function (t) {
            return void 0 !== t.layersConfig
              ? (1 === t.layersConfig.version &&
                  (function (t) {
                    for (const e of t.layers)
                      for (const t of e.controls)
                        if ('Key' === t.type) {
                          const e = t;
                          'number' == typeof e.mapTo && (e.mapTo = [e.mapTo]);
                        }
                  })(t.layersConfig),
                t.layersConfig)
              : void 0 !== t.layers
    ...
    22: [
      function (t, e, n) {
        'use strict';
        (Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.initLayersControl = void 0));
        const o = t('./grid'),
          i = t('./button'),
          r = t('./keyboard'),
          s = t('./mouse/mouse-common'),
          a = t('./options'),
          c = t('../dom/pointer'),
          u = t('nipplejs');
        n.initLayersControl = function (t, e, n, i, a, c, u) {
          let h = e.layers[0];
          if (void 0 !== u)
          ...
          return (function (t, e, n, i, a, c) {
            const u = (0, r.keyboard)(e, n),
              h = (0, s.mouse)(i.autolock, i.sensitivity, e, n),
              p = [];
            function v(r, s) {
              var u;
              for (const t of p) t();
              p.splice(0, p.length);
              const h = (0, o.getGrid)(t.grid).getConfiguration(r, s, c),
                v = new l();
              for (const e of t.controls) {
                const { row: t, column: n, type: o } = e;
                'NippleActivator' === o && f(h, t, n);
              }
              let g = -1;
              if (
                0 ===
                (null === (u = e.options.optionControls) || void 0 === u
                  ? void 0
                  : u.length)
              )
                for (const e of t.controls) {
                  const { row: t, type: n } = e;
                  if ('Options' === n) {
                    g = t;
                    break;
                  }
              ...
              if (a)
                for (const e of t.controls) {
                  const { row: t } = e;
                  let n = e.column;
                  const o = h.cells[t].length,
                    i = o / 2;
                  (t === g && n >= i && (n = Math.min(n + 1, o - 1)),
                    void 0 === m[t] &&
                      (m[t] = {
                        leftStart: i,
                        leftEnd: 0,
                    ...
                    n < i
                      ? ((m[t].leftStart = Math.min(m[t].leftStart, n)),
                        (m[t].leftEnd = Math.max(m[t].leftEnd, n)))
                      : ((m[t].rightStart = Math.min(m[t].rightStart, n)),
                        (m[t].rightEnd = Math.max(m[t].rightEnd, n))));
                }
              for (const o of t.controls) {
                const t = d[o.type];
                if (void 0 === t) {
                  console.error(
                    "Factory for control '" + o.type + "' is not defined"
                  );
                  continue;
                }
                const r = { ...o },
                  s = h.cells[o.row].length,
                  c = s / 2;
                if (
                  (g === o.row &&
                    o.column >= c &&
                    (r.column = Math.min(r.column + 1, s - 1)),
                  a)
                ) {
                  const {
                      leftStart: t,
        ...
        class l {
          ...
          register(t, e, n) {
            this.sensors[e + '_' + t] = n;
          }
        }
        const d = {
          Key: function (t, e, n, o, r, s) {
            const { cells: a, columnWidth: c } = o,
              { row: u, column: l } = t,
              { centerX: d, centerY: h } = a[u][l],
              f = {
                onDown: () => {
                  for (const e of t.mapTo) n.sendKeyEvent(e, !0);
                },
                onUp: () => {
                  for (const e of t.mapTo) n.sendKeyEvent(e, !1);
                },
              };
            if (
              (r.register(u, l, { activate: f.onDown, deactivate: f.onUp }),
              p(o, u, l))
            )
              return () => {};
            const v = (0, i.createButton)(t.symbol, f, c);
            return (
              (v.style.position = 'absolute'),
              (v.style.left = d - v.widthPx / 2 + 'px'),
              (v.style.top = h - v.heightPx / 2 + 'px'),
              e.mouseOverlay.appendChild(v),
              () => e.mouseOverlay.removeChild(v)
            );
          },
          Options: function (t, e, n, o, i, r) {
            var s;
            if (
              0 ===
              (null === (s = e.options.optionControls) || void 0 === s
                ? void 0
                : s.length)
            )
              return () => {};
            if (
              void 0 !== e.options.optionControls &&
              1 === e.options.optionControls.length &&
              'keyboard' === e.options.optionControls[0]
            )
              return h(t, e, n, o, i, r);
            const { cells: c, columnWidth: u, rowHeight: l } = o,
              { row: d, column: p } = t,
              { centerX: f, centerY: v } = c[d][p],
              g = v - l / 2,
              m = f - u / 2,
              y = o.width - m - u;
            return (0, a.options)(e, ['default'], () => {}, u, g, y);
          },
          Keyboard: h,
          Switch: function (t, e, n, o, r, s) {
            const { cells: a, columnWidth: c } = o,
              { row: u, column: l } = t,
              { centerX: d, centerY: h } = a[u][l],
              p = (0, i.createButton)(
                ...
                {
                  onUp: () =>
                    s.setLayersConfig(s.getLayersConfig(), t.layerName),
                },
                c
              );
            return (
              ...
              e.mouseOverlay.appendChild(p),
              () => {
                e.mouseOverlay.removeChild(p);
              }
            );
          },
          ScreenMove: function (t, e, n, o, r, s) {
            const { cells: a, columnWidth: c } = o,
              { row: u, column: l } = t,
              { centerX: d, centerY: h } = a[u][l];
            let f = 0.5,
              v = 0.5;
            t.direction.indexOf('up') >= 0 && (v = 0);
            t.direction.indexOf('down') >= 0 && (v = 1);
            t.direction.indexOf('left') >= 0 && (f = 0);
            t.direction.indexOf('right') >= 0 && (f = 1);
            const g = {
              onDown: () => {
                n.sendMouseMotion(f, v);
              },
              onUp: () => {
            ...
            if (
              (r.register(u, l, { activate: g.onDown, deactivate: g.onUp }),
              p(o, u, l))
            )
              return () => {};
            const m = (0, i.createButton)(t.symbol, g, c);
            return (
              (m.style.position = 'absolute'),
              (m.style.left = d - m.widthPx / 2 + 'px'),
              (m.style.top = h - m.heightPx / 2 + 'px'),
              e.mouseOverlay.appendChild(m),
              () => e.mouseOverlay.removeChild(m)
            );
          },
          PointerButton: function (t, e, n, o, r, s) {
            const { cells: a, columnWidth: c } = o,
              { row: u, column: l, click: d } = t,
              { centerX: h, centerY: f } = a[u][l],
              v = {
                onDown: () => {
                  d
                    ? n.sendMouseButton(t.button, !0)
                    : (e.pointerButton = t.button);
                },
                onUp: () => {
                  d ? n.sendMouseButton(t.button, !1) : (e.pointerButton = 0);
                },
              };
            if (
              (r.register(u, l, { activate: v.onDown, deactivate: v.onUp }),
              p(o, u, l))
            )
              return () => {};
            const g = (0, i.createButton)(t.symbol, v, c);
            return (
              (g.style.position = 'absolute'),
              (g.style.left = h - g.widthPx / 2 + 'px'),
              (g.style.top = f - g.heightPx / 2 + 'px'),
              e.mouseOverlay.appendChild(g),
              () => e.mouseOverlay.removeChild(g)
            );
          },
          PointerMove: function (t, e, n, o, r, s) {
            const { cells: a, columnWidth: c } = o,
              { row: u, column: l, x: d, y: h } = t,
              { centerX: f, centerY: v } = a[u][l],
              g = {
                onDown: () => {
                  n.sendMouseMotion(d, h);
                },
                onUp: () => {
                  n.sendMouseMotion(d, h);
                },
            ...
            return (
              ...
              (m.style.top = v - m.heightPx / 2 + 'px'),
              e.mouseOverlay.appendChild(m),
              () => e.mouseOverlay.removeChild(m)
            );
          },
          PointerReset: function (t, e, n, o, r, s) {
            const { cells: a, columnWidth: c } = o,
              { row: u, column: l } = t,
              { centerX: d, centerY: h } = a[u][l],
              f = {
            ...
            if (
              (r.register(u, l, { activate: f.onDown, deactivate: () => {} }),
              p(o, u, l))
            )
              return () => {};
            const v = (0, i.createButton)(t.symbol, f, c);
          ...
          PointerToggle: function (t, e, n, o, r, s) {
            const { cells: a, columnWidth: c } = o,
              { row: u, column: l } = t,
              { centerX: d, centerY: h } = a[u][l],
              f = {
                onDown: () => {
                  ((e.pointerDisabled = !e.pointerDisabled),
                    e.pointerDisabled
                      ? v.classList.contains('emulator-button-highlight') ||
                        v.classList.add('emulator-button-highlight')
                      : v.classList.remove('emulator-button-highlight'));
                },
              };
            if (
              (r.register(u, l, { activate: f.onDown, deactivate: () => {} }),
          ...
          NippleActivator: function (t, e, n, o, i, r) {
            const {
                cells: s,
                columnWidth: a,
                rowHeight: l,
              ...
              { row: p, column: f } = t,
              { centerX: v, centerY: g } = s[p][f],
              m = document.createElement('div'),
              y = 1.5,
              b = Math.max(0, v - a * y),
              _ = Math.max(0, g - l * y),
              w = Math.max(0, d - v - a * y),
              D = Math.max(0, h - g - l * y);
            ((m.style.position = 'absolute'),
              (m.style.zIndex = '999'),
              (m.style.left = b + 'px'),
              (m.style.top = _ + 'px'),
            ...
            x.on('move', (t, e) => {
              if (e.distance < 10)
                return (i.deactivate(E, B), (B = -1), void (E = -1));
              let n = -1,
                o = -1;
              const r = 22.5,
                s = e.angle.degree;
                      ...
                      : s > 202.5 && s <= 247.5
                        ...
                        : s > 247.5 && s <= 292.5
                          ...
                          : s > 292.5 && s <= 337.5
                            ...
                            : ((n = f + 1), (o = p)),
                (B === n && E === o) ||
                  (i.deactivate(E, B), i.activate(o, n), (B = n), (E = o)));
            });
            let k = !1;
            (x.on('start', () => {
              k = !0;
              ...
              x.on('end', () => {
                ((k = !1), i.deactivate(E, B), (E = -1), (B = -1));
              }));
            const K = { capture: !0 };
            function C(t) {
              k && x.processOnEnd(t);
            }
            for (const t of c.pointer.enders)
              e.mouseOverlay.addEventListener(t, C, K);
            return () => {
              (x.destroy(), e.mouseOverlay.removeChild(m));
              for (const t of c.pointer.enders)
                e.mouseOverlay.removeEventListener(t, C, K);
            };
          },
        };
        function h(t, e, n, o, r, s) {
          const { cells: a, columnWidth: c } = o,
            ...
            p = (0, i.createButton)(
              'keyboard',
              { onUp: () => e.toggleKeyboard() },
              c
            ),
            f = t => {
              t
                ? p.children[0].classList.add('emulator-control-close-icon')
                : p.children[0].classList.remove('emulator-control-close-icon');
            };
          return (
            e.setOnKeyboardVisibility(f),
            (p.style.position = 'absolute'),
            (p.style.left = d - p.widthPx / 2 + 'px'),
            (p.style.top = h - p.heightPx / 2 + 'px'),
            e.mouseOverlay.appendChild(p),
            () => {
              (e.mouseOverlay.removeChild(p), e.removeOnKeyboardVisibility(f));
            }
          );
        }
        function p(t, e, n) {
          return !0 === t.cells[e][n].hidden;
        }
        function f(t, e, n) {
          function o(o, i) {
            if ((o !== e || i !== n) && o >= 0 && o < t.cells.length) {
              const e = t.cells[o];
              i >= 0 && i < e.length && (e[i].hidden = !0);
            }
          }
          for (let t = e - 1; t <= e + 1; ++t)
            for (let e = n - 1; e <= n + 1; ++e) o(t, e);
        }
      },
      {
        '../dom/pointer': 36,
    ...
    23: [
      function (t, e, n) {
        'use strict';
        (Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.initLegacyLayersControl = void 0));
        const o = t('./button'),
          i = t('./mouse/mouse-common'),
          r = t('./nipple'),
          s = t('./options'),
          a = t('./keyboard');
        n.initLegacyLayersControl = function (t, e, n, c) {
          var u;
          const l = Object.keys(n),
            ...
            h = s => {
              ...
              const u = n[s];
              void 0 !== u &&
                ((d.keyboard = (0, a.keyboard)(e, c, u.mapper)),
                void 0 !== u.gestures && u.gestures.length > 0
                  ? (d.gestures = (0, r.nipple)(e, c, u.gestures))
                  : (d.mouse = (0, i.mouse)(t.autolock, t.sensitivity, e, c)),
                void 0 !== u.buttons &&
                  u.buttons.length &&
                  (d.buttons = (0, o.deprecatedButton)(e, c, u.buttons, 54)));
            },
            p =
              0 ===
              (null === (u = e.options.optionControls) || void 0 === u
    ...
    24: [
      function (t, e, n) {
        'use strict';
        (Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.mouse = n.mount = n.mapXY = void 0));
        const o = t('../../dom/pointer'),
          i = t('./mouse-swipe'),
          r = t('./mouse-not-locked'),
          s = t('./mouse-locked'),
          a = 0.01;
        ((n.mapXY = function (t, e, n, o) {
          const i = n.width(),
            r = n.height(),
            s = o.width,
            c = o.height,
          ...
          const h = (c - d) / 2,
            p = (s - l) / 2;
          let f = Math.max(0, Math.min(1, (t - p) / l)),
            v = Math.max(0, Math.min(1, (e - h) / d));
          return (
            f <= a && (f = 0),
            f >= 0.99 && (f = 1),
            v <= a && (v = 0),
          ...
          (n.mount = function (t, e, n, i, r, s) {
            let a = 0;
            const c = i => {
                if (i.target !== t) return;
                if (e.pointerDisabled) return void i.stopPropagation();
                const r = (0, o.getPointerState)(i, t);
                ((a = r.button || e.pointerButton),
                  n(r.x, r.y, a),
                  i.stopPropagation());
              },
              u = n => {
                if (n.target !== t) return;
                if (e.pointerDisabled) return void n.stopPropagation();
                const r = (0, o.getPointerState)(n, t);
                (i(r.x, r.y, r.mX, r.mY), n.stopPropagation());
              },
              l = n => {
                if (e.pointerDisabled) return void n.stopPropagation();
                const i = (0, o.getPointerState)(n, t);
                (r(i.x, i.y, a), n.stopPropagation());
              },
              d = n => {
                if (n.target !== t) return;
                if (e.pointerDisabled) return void n.stopPropagation();
              ...
              p = { capture: !1 };
            for (const e of o.pointer.starters) t.addEventListener(e, c, p);
            for (const e of o.pointer.changers) t.addEventListener(e, u, p);
            for (const e of o.pointer.enders) t.addEventListener(e, l, p);
            for (const e of o.pointer.prevents) t.addEventListener(e, h, p);
            for (const e of o.pointer.leavers) t.addEventListener(e, d, p);
            return () => {
              for (const e of o.pointer.starters)
                t.removeEventListener(e, c, p);
              for (const e of o.pointer.changers)
                t.removeEventListener(e, u, p);
              for (const e of o.pointer.enders) t.removeEventListener(e, l, p);
              for (const e of o.pointer.prevents)
                t.removeEventListener(e, h, p);
              for (const e of o.pointer.leavers) t.removeEventListener(e, d, p);
            };
          }),
          (n.mouse = function (t, e, n, a) {
            return t && !o.pointer.canLock
              ? (0, i.mouseSwipe)(e, n, a)
              : t
                ? (0, s.mouseLocked)(e, n, a)
                : (0, r.mouseNotLocked)(n, a);
          }));
      },
      {
        '../../dom/pointer': 36,
    ...
    25: [
      function (t, e, n) {
        'use strict';
        (Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.mouseLocked = void 0));
        const o = t('./mouse-common');
        n.mouseLocked = function (t, e, n) {
          const i = e.mouseOverlay;
          function r() {
          ...
          return (0, o.mount)(
            ...
            function (t, e, o) {
              ...
              } else n.sendMouseButton(o, !0);
            },
            function (e, o, i, s) {
              r() ||
                (0 === i && 0 === s) ||
                n.sendMouseRelativeMotion(i * t, s * t);
            },
            function (t, e, o) {
    ...
    26: [
      function (t, e, n) {
        'use strict';
        (Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.mouseNotLocked = void 0));
        const o = t('./mouse-common');
        n.mouseNotLocked = function (t, e) {
          const n = t.mouseOverlay,
            i = (n, i) => (0, o.mapXY)(n, i, e, t);
          return (
            ...
            (0, o.mount)(
              ...
              function (t, n, o) {
                const r = i(t, n);
                (e.sendMouseMotion(r.x, r.y), e.sendMouseButton(o, !0));
              },
              function (t, n, o, r) {
                const s = i(t, n);
                e.sendMouseMotion(s.x, s.y);
              },
              function (t, n, o) {
                const r = i(t, n);
                (e.sendMouseMotion(r.x, r.y), e.sendMouseButton(o, !1));
              },
              function (t, n) {
                const o = i(t, n);
                e.sendMouseMotion(o.x, o.y);
              }
            )
          );
        };
          ...
          return (0, o.mount)(
            ...
            function (e, o, i, r) {
              (void 0 === i && (i = e - a),
                ...
                (c = o),
                (0 === i && 0 === r) ||
                  ((s += Math.abs(i) + Math.abs(r)),
                  n.sendMouseRelativeMotion(i * t * 2, r * t * 2)));
            },
            (t, o) => {
              if (Date.now() - r < 500 && s < 50) {
                const t = e.pointerButton || 0;
                (n.sendMouseButton(t, !0),
                  setTimeout(() => n.sendMouseButton(t, !1), 60));
              }
            },
            () => {}
          );
        ...
        n.nipple = function (t, e, n) {
          ...
          for (const e of n)
            'end:release' === e.event
              ...
              : e.mapTo !== i.KBD_NONE &&
                ('tap' === e.event
                  ? (u[e.joystickId] = e.mapTo)
                  : r.on(e.event, () => {
                      var n;
                      ((l[e.joystickId] = Date.now()),
                        a(),
                        (n = e.mapTo),
                        t.fireKeyDown(n),
                        (s = n));
          ...
          return (
            ...
            r.on('end', () => {
              const e = r.ids.length - 1,
                n = Date.now() - d[e];
              (!0 === c[e] && a(),
                u[e] && n < 500 && l[e] < d[e] && t.fireKeyPress(u[e]));
            }),
            () => r.destroy()
          );
        };
    ...
    29: [
      function (t, e, n) {
        'use strict';
        (Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.initNullLayersControl = void 0));
        const o = t('./keyboard'),
          i = t('./mouse/mouse-common'),
          r = t('./options');
        n.initNullLayersControl = function (t, e, n) {
          var s;
          const a = (0, o.keyboard)(e, n),
            c = (0, i.mouse)(t.autolock, t.sensitivity, e, n),
            u =
              0 ===
              (null === (s = e.options.optionControls) || void 0 === s
                ? void 0
                : s.length)
                ? () => {}
                : (0, r.options)(e, ['default'], () => {}, 54, 13.5, 0);
          return () => {
            (a(), c(), u());
          };
        };
      ...
      function (t, e, n) {
        ...
        function r(t, e) {
          ...
          return (
            ...
            (0, i.stopPropagation)(n, !1),
            n
          );
        }
        n.options = function (t, e, n, s, a, c) {
          const u = Math.round(s / 4);
          let l = !1,
            d = !1;
          const h = () => {
              const t = l ? 'flex' : 'none';
              for (const e of f) e != v && (e.style.display = t);
            },
            p = () => {
              ((l = !l), !l && d && t.toggleKeyboard(), h());
            },
            f = [
              r(e, n),
              (0, o.createButton)(
              ...
              (0, o.createButton)(
                ...
                {
                  onClick: () => {
                    (t.toggleFullscreen(), l && p());
                  },
                },
                s
              ),
              (0, o.createButton)('options', { onClick: p }, s),
            ],
            v = f[f.length - 1],
            g = f[f.length - 2].children[0],
            m = f[f.length - 4].children[0],
            y = t => {
              ((d = t),
                t
                  ? m.classList.add('emulator-control-close-icon')
                  : m.classList.remove('emulator-control-close-icon'));
            };
          (t.setOnKeyboardVisibility(y),
            y(t.keyboardVisible),
            t.setOnFullscreen(t => {
              t
                ? g.classList.contains(
                    'emulator-control-exit-fullscreen-icon'
                  ) || g.classList.add('emulator-control-exit-fullscreen-icon')
                : g.classList.remove('emulator-control-exit-fullscreen-icon');
            }),
            t.fullscreen &&
              g.classList.add('emulator-control-exit-fullscreen-icon'));
          const b = (0, i.createDiv)('emulator-options'),
            _ = d ? 'flex' : 'none';
          for (const t of f)
            (t !== v && t.classList.add('emulator-button-control'),
              (t.style.marginRight = u + 'px'),
              (t.style.marginBottom = u + 'px'),
              t !== v && (t.style.display = _),
              b.appendChild(t));
          return (
            (b.style.position = 'absolute'),
            (b.style.right = c + 'px'),
            (b.style.top = a + 'px'),
            t.mouseOverlay.appendChild(b),
            () => {
              (t.mouseOverlay.removeChild(b),
                t.setOnFullscreen(() => {}),
                t.removeOnKeyboardVisibility(y));
            }
          );
        };
      },
    ...
    31: [
      function (t, e, n) {
        'use strict';
        (Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.stopPropagation = n.createDiv = void 0));
        const o = t('./pointer');
        ((n.createDiv = function (t, e) {
          ...
          (n.stopPropagation = function (t) {
            ...
            const n = t => {
              ...
              r = { capture: !1 };
            for (const e of o.pointer.starters) t.addEventListener(e, n, r);
            for (const e of o.pointer.enders) t.addEventListener(e, n, r);
            for (const e of o.pointer.prevents) t.addEventListener(e, i, r);
          }));
      },
      { './pointer': 36 },
    ],
    32: [
      function (t, e, n) {
        ...
        (Object.defineProperty(n, '__esModule', { value: !0 }),
          ...
          (n.keyCodesToDom = {}));
        for (const t of Object.keys(n.domToKeyCodes)) {
          const e = Number.parseInt(t, 10);
          n.keyCodesToDom[n.domToKeyCodes[e]] = e;
        }
    ...
    33: [
      function (t, e, n) {
        ...
        (Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.Layers = n.layers = void 0));
        const r = t('notyf'),
          s = i(t('simple-keyboard')),
          a = t('./helpers'),
          c = t('./keys'),
          u = t('element-resize-detector')({});
        ...
        class l {
          constructor(t, e) {
            (o(this, 'options', void 0),
              o(this, 'root', void 0),
              o(this, 'loading', void 0),
              o(this, 'canvas', void 0),
              o(this, 'video', void 0),
              o(this, 'mouseOverlay', void 0),
              o(this, 'width', void 0),
              o(this, 'height', void 0),
              o(this, 'fullscreen', !1),
              o(this, 'keyboardVisible', !1),
              o(this, 'pointerLock', !1),
              o(this, 'pointerDisabled', !1),
              o(this, 'pointerButton', 0),
              o(this, 'notyf', new r.Notyf()),
              o(this, 'toggleKeyboard', () => !1),
              o(this, 'fullscreenElement', void 0),
              o(this, 'clickToStart', void 0),
              o(this, 'loaderText', void 0),
              o(this, 'onResize', void 0),
              o(this, 'onKeyDown', void 0),
              o(this, 'onKeyUp', void 0),
              o(this, 'onKeyPress', void 0),
              o(this, 'onKeysPress', void 0),
              o(this, 'onSave', void 0),
              o(this, 'onSaveStarted', void 0),
              o(this, 'onSaveEnded', void 0),
              o(this, 'onFullscreenChanged', []),
              o(this, 'onKeyboardChanged', []),
              (this.options = e),
              (this.root = t),
              ...
              (this.mouseOverlay = (0, a.createDiv)(
                'emulator-mouse-overlay',
                ''
              )),
              (this.clickToStart = (0, a.createDiv)(
              ...
              (this.onSaveStarted = () => {}),
              (this.onSaveEnded = () => {}),
              u.listenTo(this.root, e => {
                if (e === t) {
                  ((this.width = e.offsetWidth),
                    (this.height = e.offsetHeight));
                  for (const t of this.onResize) t(this.width, this.height);
                }
              }),
              this.initKeyEvents(),
              this.initKeyboard(),
              ...
              (this.fullscreenElement.onfullscreenchange = () => {
                if (document.fullscreenElement !== this.fullscreenElement) {
                  this.fullscreen = !1;
                  for (const t of this.onFullscreenChanged) t(this.fullscreen);
                }
              }));
          }
          initKeyEvents() {
            const t = this.options.keyboardInputDiv ?? this.root;
            ((t.style.outline = 'none'),
              (t.tabIndex && -1 !== t.tabIndex) || (t.tabIndex = 0),
              t.addEventListener('keydown', t => {
                const e = (0, c.domToKeyCode)(t.keyCode);
                (this.onKeyDown(e), t.stopPropagation(), t.preventDefault());
              }),
              t.addEventListener('keyup', t => {
                const e = (0, c.domToKeyCode)(t.keyCode);
                (this.onKeyUp(e), t.stopPropagation(), t.preventDefault());
              }));
          }
          preventContextMenu() {
            this.root.addEventListener(
              'contextmenu',
              t => (t.stopPropagation(), t.preventDefault(), !1)
            );
          }
          addOnResize(t) {
          ...
          removeOnResize(t) {
            this.onResize = this.onResize.filter(e => e !== t);
          }
          setOnKeyDown(t) {
            this.onKeyDown = t;
          }
          ...
          toggleFullscreen() {
            if (this.fullscreen) {
              ((this.fullscreen = !1),
                this.fullscreenElement.classList.contains(
                    ...
                    : document.webkitExitFullscreen
                      ...
                      : document.mozCancelFullScreen
                        ...
                        : document.msExitFullscreen &&
                          document.msExitFullscreen());
              for (const t of this.onFullscreenChanged) t(!1);
            } else {
              this.fullscreen = !0;
                  ...
                  : t.mozRequestFullScreen
                    ...
                    : t.msRequestFullscreen
                      ...
                      : t.webkitEnterFullscreen
                        ? t.webkitEnterFullscreen()
                        : this.fullscreenElement.classList.add(
                            'emulator-fullscreen-workaround'
                          );
              for (const t of this.onFullscreenChanged) t(!0);
            }
          }
          setOnFullscreen(t) {
            this.onFullscreenChanged.push(t);
          }
          removeOnFullscreen(t) {
            this.onFullscreenChanged = this.onFullscreenChanged.filter(
              e => e !== t
            );
          }
          setOnKeyboardVisibility(t) {
            this.onKeyboardChanged.push(t);
          }
          removeOnKeyboardVisibility(t) {
            this.onKeyboardChanged = this.onKeyboardChanged.filter(
              e => e !== t
            );
          }
          save() {
            return (
              ...
              this.onSave()
                ...
                .catch(t => {
                  (this.notyf.error(t.message), this.onSaveEnded());
                })
            );
          }
          setOnSave(t) {
          ...
          initKeyboard() {
            ...
            let n = 0;
            const o = this.options.keyboardDiv || (0, a.createDiv)('');
            (o.classList.add('emulator-keyboard'),
              (o.style.display = 'none'),
              (0, a.stopPropagation)(o));
            const i = new s.default(o, {
              layout: {
                en: [
              ...
              onKeyPress: t => {
                if ('⎘' === t) return;
                const e = d(t);
                for (const t of e) this.fireKeyDown(t);
              },
              onKeyReleased: t => {
                if ('⎘' === t)
                  return (
                    (n = (n + 1) % e.length),
                    void i.setOptions({ display: e[n] })
                  );
                const o = d(t);
                for (const t of o) this.fireKeyUp(t);
              },
            ...
            ((this.toggleKeyboard = () => {
              t = !t;
              const e = t ? 'block' : 'none';
              o.style.display = e;
              for (const e of this.onKeyboardChanged) e(t);
              return ((this.keyboardVisible = t), t);
            }),
              this.options.keyboardDiv || this.mouseOverlay.appendChild(o));
          }
        }
        function d(t) {
          if (t.length > 1)
          ...
          if (',' === t) return [c.KBD_comma];
          if ('.' === t) return [c.KBD_period];
          if ("'" === t) return [c.KBD_quote];
          if (':' === t) return [c.KBD_semicolon];
          if ('{' === t) return [c.KBD_leftshift, c.KBD_leftbracket];
          if ('}' === t) return [c.KBD_leftshift, c.KBD_rightbracket];
          const e = (0, c.domToKeyCode)(t.toUpperCase().charCodeAt(0));
          return 0 === e ? [] : [e];
        }
        n.Layers = l;
      },
    ...
    35: [
      function (t, e, n) {
        ...
        n.MemStorage = class {
          constructor() {
            (o(this, 'length', 0), o(this, 'storage', {}));
          }
          setItem(t, e) {
            ((this.storage[t] = e),
    ...
    37: [
      function (t, e, n) {
        ...
        (Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.LStorage = void 0));
        const i = t('./mem-storage');
        n.LStorage = class {
          constructor(t, e) {
            (o(this, 'backend', void 0),
              o(this, 'length', void 0),
          ...
          testBackend() {
            ...
            this.backend.setItem(t, '123');
            const e = this.backend.getItem(t);
            this.backend.removeItem(t);
            if (!('123' === e && null === this.backend.getItem(t)))
          ...
          clear() {
            ...
            const t = [];
            for (let e = 0; e < this.backend.length; ++e) {
              const n = this.backend.key(e);
              n && n.startsWith(this.prefix) && t.push(n);
            }
            for (const e of t) this.backend.removeItem(e);
            this.length = this.backend.length;
          }
          key(t) {
          ...
          setItem(t, e) {
            if (!e || void 0 === e.length || 0 === e.length)
              return void this.writeStringToKey(t, '');
            let n = 0;
            for (; n < e.length; ) {
              let o = e.substr(n, 1024);
              ((n += o.length),
                n < e.length && (o += '@'),
                this.writeStringToKey(t, o),
                (t += '.'));
            }
          }
          getItem(t) {
            let e = this.readStringFromKey(t);
            if (null === e) return null;
            if (0 === e.length) return e;
            for (; '@' === e[e.length - 1]; ) {
              ((e = e.substr(0, e.length - 1)), (t += '.'));
              const n = this.readStringFromKey(t);
              e += null === n ? '' : n;
            }
            return e;
          }
          removeItem(t) {
            (this.backend.removeItem(this.prefix + t),
              (this.length = this.backend.length));
          }
          writeStringToKey(t, e) {
            (this.backend.setItem(this.prefix + t, e),
              (this.length = this.backend.length));
          }
          readStringFromKey(t) {
    ...
    38: [
      function (t, e, n) {
        ...
        const i = t('./build'),
          ...
          u = t('./graphics/webgl'),
          l = t('./graphics/video'),
          d = t('./controls/keyboard'),
          h = t('./controls/mouse/mouse-common'),
          p = t('./controls/nipple'),
          f = t('./controls/options'),
          v = t('./dom/keys'),
          g = t('./sound/audio-node'),
          m = t('./notification/notyf'),
          y = t('./persist/save-load'),
          b = t('./controls/grid'),
          _ = t('./dom/pointer'),
          w = t('./dom/storage'),
          D = t('./js-dos');
        class x {
          constructor() {
            (o(this, 'build', i.Build),
              o(this, 'dom', {
                layers: r.layers,
                lifecycle: s.lifecycle,
                pointers: _.pointers,
                storage: new w.LStorage(void 0, 'emulators.ui.'),
              }),
              o(this, 'network', { resolveBundle: a.resolveBundle }),
              o(this, 'graphics', {
                webGl: u.webGl,
                _2d: c._2d,
                video: l.video,
              }),
              o(this, 'sound', { audioNode: g.audioNode }),
              o(this, 'persist', { save: y.save, load: y.load }),
              o(this, 'controls', {
                getGrid: b.getGrid,
                namedKeyCodes: v.namedKeyCodes,
                domToKeyCodes: v.domToKeyCodes,
                domToKeyCode: v.domToKeyCode,
                keyCodesToDom: v.keyCodesToDom,
                keyboard: d.keyboard,
                mouse: h.mouse,
                nipple: p.nipple,
                options: f.options,
              }),
              o(this, 'notifications', { notyf: m.notyf }),
              o(this, 'dos', (t, e) => new D.DosInstance(t, B, e || {})));
          }
        }
        n.EmulatorsUi = x;
        const B = new x();
        ((window.emulatorsUi = B), (window.Dos = B.dos));
      },
      {
        './build': 17,
        './controls/grid': 19,
          ...
          (n._2d = function (t, e, n) {
            ...
            const u = () => {
                ...
                (i > s && ((i = s), (e = s * t)),
                  ...
                  (o.style.top = (s - i) / 2 + 'px'),
                  (o.style.left = (r - e) / 2 + 'px'),
                  (o.style.width = e + 'px'),
                  (o.style.height = i + 'px'));
              },
              l = (t, e) => {
            ...
            const h = (t, e) => {
              ((a = t),
                ...
                (o.width = a),
                (o.height = c),
                (d = new Uint8ClampedArray(t * e * 4)),
                u());
            };
            (e.events().onFrameSize(h),
              e.events().onFrame((t, e) => {
                ...
                for (; r < d.length; )
                  ((d[r++] = n[o++]),
                    ...
                    (d[r++] = 255),
                    n.length === d.length && o++);
                i.putImageData(new ImageData(d, a, c), 0, 0);
              }),
              h(e.width(), e.height()),
              e.events().onExit(() => {
                t.removeOnResize(l);
    ...
    40: [
      function (t, e, n) {
        ...
        (Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.video = void 0),
          (n.video = function (t, e) {
            (t.switchToVideo(),
              e.events().onMessage((e, n) => {
                'onremotestream' === e &&
                  window.Janus.attachMediaStream(t.video, n);
              }));
          }));
      },
      {},
      ...
      function (t, e, n) {
        ...
        function o(t, e, n) {
          ...
          if (
            ...
            const e = t.getShaderInfoLog(o);
            throw (
              t.deleteShader(o),
              new Error('An error occurred compiling the shaders: ' + e)
            );
          }
          return o;
        }
        n.webGl = function (t, e, n) {
          const i = t.canvas,
            r = i.getContext('webgl');
          if (null === r)
            throw new Error('Unable to create webgl context on given canvas');
          const s = (function (t, e, n) {
              const i = o(t, t.VERTEX_SHADER, e),
                r = o(t, t.FRAGMENT_SHADER, n),
                s = t.createProgram();
              if (
                (t.attachShader(s, i),
                t.attachShader(s, r),
            ...
            a = r.getAttribLocation(s, 'aVertexPosition'),
            c = r.getAttribLocation(s, 'aTextureCoord'),
            u = r.getUniformLocation(s, 'uSampler');
          !(function (t, e, n) {
            ...
            (t.bufferData(t.ARRAY_BUFFER, new Float32Array(s), t.STATIC_DRAW),
          ...
          const g = () => {
              ...
              (o > p && ((o = p), (e = p * t)),
                ...
                (i.style.top = (p - o) / 2 + 'px'),
                (i.style.left = (h - e) / 2 + 'px'),
                (i.style.width = e + 'px'),
                (i.style.height = o + 'px'));
            },
            m = (t, e) => {
          ...
          (e.events().onFrameSize(y), y(e.width(), e.height()));
          let b = null,
            _ = null,
            w = 0;
          e.events().onFrame((t, e) => {
            ((_ = null != t ? t : e),
              (w = null != t ? r.RGB : r.RGBA),
              null === b && (b = requestAnimationFrame(D)));
          });
          const D = () => {
            (r.texImage2D(r.TEXTURE_2D, 0, w, f, v, 0, w, r.UNSIGNED_BYTE, _),
    ...
    42: [
      function (t, e, n) {
        ...
        (Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.DosInstance = void 0));
        const i = t('./controls/layers-config'),
          r = t('./controls/legacy-layers-control'),
          s = t('./controls/null-layers-control'),
          a = t('./controls/layers-control'),
          c = t('./dom/pointer');
        n.DosInstance = class {
          constructor(t, e, n) {
            (o(this, 'emulatorsUi', void 0),
              o(this, 'emulatorFunction', void 0),
              o(this, 'createTransportLayer', void 0),
              o(this, 'layers', void 0),
              o(this, 'layersConfig', null),
              o(this, 'ciPromise', void 0),
              o(this, 'options', void 0),
              o(this, 'mobileControls', void 0),
              o(this, 'mirroredControls', void 0),
              o(this, 'scaleControls', void 0),
              o(this, 'autolock', void 0),
              o(this, 'sensitivity', void 0),
              o(this, 'storage', void 0),
              o(this, 'volume', void 0),
              o(this, 'clickToStart', void 0),
              o(this, 'unbindControls', () => {}),
              o(this, 'storedLayersConfig', null),
              o(this, 'onMobileControlsChanged', void 0),
              o(this, 'onSensitivityChanged', []),
              o(this, 'onScaleChanged', []),
              o(this, 'onVolumeChanged', []),
              o(this, 'setVolumeImplFn', () => {}),
              o(this, 'registerOnSensitivityChanged', t => {
                this.onSensitivityChanged.push(t);
              }),
              o(this, 'removeOnSensitivityChanged', t => {
                this.onSensitivityChanged = this.onSensitivityChanged.filter(
                  e => e !== t
                );
              }),
              o(this, 'registerOnScaleChanged', t => {
                this.onScaleChanged.push(t);
              }),
              o(this, 'removeOnScaleChanged', t => {
                this.onScaleChanged = this.onScaleChanged.filter(e => e !== t);
              }),
              o(this, 'registerOnVolumeChanged', t => {
                this.onVolumeChanged.push(t);
              }),
              o(this, 'removeOnVolumeChanged', t => {
                this.onVolumeChanged = this.onVolumeChanged.filter(
                  e => e !== t
                );
              }),
              (this.options = n),
              (this.emulatorsUi = e),
              (this.storage = e.dom.storage),
              ...
              (this.mobileControls = c.pointers.bind.mobile),
              (this.autolock = !1),
              (this.mirroredControls =
                !0 === this.options.mirroredControls ||
          ...
          async run(t, e, n) {
            ...
            const a = null != n && n.length > 0 ? n : t + '.changes';
            let c;
            try {
              c = await this.runBundle(t, e, a);
            } catch (t) {
              throw (
            ...
            const u = this.emulatorsUi;
            if ('janus' === this.emulatorFunction)
              u.graphics.video(this.layers, c);
            else {
              u.persist.save(a, this.layers, c, emulators);
              try {
                if (!0 === this.options.noWebGL)
                  throw new Error('WebGL is disabled by options');
                u.graphics.webGl(this.layers, c, this.options.aspect);
              } catch (t) {
                (console.error(
                  'Unable to create webgl canvas, fallback to 2d rendering'
                ),
                  u.graphics._2d(this.layers, c, this.options.aspect));
              }
              ((this.setVolumeImplFn = u.sound.audioNode(c)),
                this.setVolumeImplFn(this.volume));
            }
            u.dom.lifecycle(c);
            const l = await c.config();
            return (
              (this.autolock =
                !0 ===
                (null === (o = l.output) ||
                ...
                void 0 === s
                  ? void 0
                  : s.value)),
              await this.setLayersConfig((0, i.extractLayersConfig)(l)),
              this.mobileControls ||
                ((this.mobileControls = !0), this.disableMobileControls()),
          ...
          async stop() {
            if ((this.layers.showLoadingLayer(), void 0 === this.ciPromise))
              return;
            const t = await this.ciPromise;
            (delete this.ciPromise, await t.exit());
          }
          async setLayersConfig(t, e) {
            if (void 0 === this.ciPromise) return;
            const n = await this.ciPromise;
            ((this.layersConfig = t),
              this.unbindControls(),
              null === t
                ? (this.unbindControls = (0, s.initNullLayersControl)(
                    this,
                    this.layers,
                    n
                  ))
                : void 0 === t.version
                  ? (this.unbindControls = (0, r.initLegacyLayersControl)(
                      this,
                      this.layers,
                      t,
                      n
                    ))
                  : (this.unbindControls = (0, a.initLayersControl)(
                      this.layers,
                      t,
                      n,
                      this,
          ...
          async setMirroredControls(t) {
            this.mirroredControls !== t &&
              ((this.mirroredControls = t),
              this.storage.setItem('mirroredControls', t + ''),
              t
                ? this.mobileControls
          ...
          async setScaleControls(t) {
            if (t !== this.scaleControls) {
              ((this.scaleControls = t),
                this.storage.setItem('scaleControls', t + ''),
                this.mobileControls &&
                  (await this.setLayersConfig(this.layersConfig)));
              for (const t of this.onScaleChanged) t(this.scaleControls);
            }
          }
          async setSensitivity(t) {
            if (t !== this.sensitivity) {
              ((this.sensitivity = t),
                this.storage.setItem('sensitivity', t + ''),
                await this.setLayersConfig(this.layersConfig));
              for (const t of this.onSensitivityChanged) t(this.sensitivity);
            }
          }
          async setVolume(t) {
            ((this.volume = t),
              this.storage.setItem('volume', t + ''),
              this.setVolumeImplFn(t));
            for (const t of this.onVolumeChanged) t(this.volume);
          }
          async setAutolock(t) {
            t !== this.autolock &&
              ((this.autolock = t),
          ...
          setOnMobileControlsChanged(t) {
            this.onMobileControlsChanged = t;
          }
          async runBundle(t, e, n) {
            const o = this.emulatorsUi;
            if ('janus' === this.emulatorFunction)
              (this.layers.setLoadingMessage('Connecting...'),
                (this.ciPromise = emulators.janus(t)));
            else {
              this.layers.setLoadingMessage('Downloading bundle ...');
              const i = o.network.resolveBundle(t, {
                  onprogress: t =>
                ...
                r = {
                  onExtractProgress: (t, e, n, o) => {
                    if (0 !== t) return;
                    const i = Math.round((n / o) * 100),
                      r = e.lastIndexOf('/'),
                      s = e.substring(r + 1);
                    this.layers.setLoadingMessage(
                      'Extracting ' + i + '% (' + s + ')'
              ...
              try {
                ...
                t =
                  null != e && e.length > 0
                    ? await o.network.resolveBundle(e, { httpCache: !1 })
                    : await o.persist.load(n, emulators);
                const s = await i;
                'backend' === this.emulatorFunction
                ...
                'backend' === this.emulatorFunction
                  ...
                  : (this.ciPromise = emulators[this.emulatorFunction]([t], r));
              }
            }
      ...
      {
        './controls/layers-config': 21,
        './controls/layers-control': 22,
        './controls/legacy-layers-control': 23,
        './controls/null-layers-control': 29,
        './dom/pointer': 36,
      },
    ],
    43: [
      function (t, e, n) {
        ...
        (Object.defineProperty(n, '__esModule', { value: !0 }),
          ...
          (n.resolveBundle = async function (t, e) {
            const n = null == e ? void 0 : e.onprogress,
              o = !(!1 === (null == e ? void 0 : e.httpCache));
            return new Promise((e, i) => {
              const r = new XMLHttpRequest();
              (r.open('GET', t, !0),
                r.overrideMimeType('text/plain; charset=x-user-defined'),
                r.addEventListener('error', () => {
                  i(new Error("Network error, can't download " + t));
                }),
                r.addEventListener(
                  'abort',
                  () => {
                    i(new Error('Request canceled for url ' + t));
                  },
                  !1
                ),
                ...
                (r.onreadystatechange = () => {
                  4 === r.readyState &&
                    (200 === r.status
                      ? (void 0 !== n && n(100), e(new Uint8Array(r.response)))
                      : i(new Error("Network error, can't download " + t)));
                }),
                void 0 !== n &&
                  (r.onprogress = t => {
                    if (t.total && t.total > 0) {
                      const e = Math.round((1e4 * t.loaded) / t.total) / 100;
                      n(e);
                    }
                  }),
                !1 === o &&
            ...
            e.events().onMessage(function (t) {
              if ('error' === t) {
                for (
                  ...
                  o[i - 1] = arguments[i];
                n.error({ message: JSON.stringify(o) });
              }
            });
          }));
      },
        ...
        class i {
          ...
          get(t, e) {
            return void 0 !== e
              ? Promise.resolve(e)
              : Promise.reject(
                  new Error('Cache is not supported on this host')
                );
          }
          forEach(t, e) {
            e();
        ...
        class r {
          constructor(t, e, n) {
            if (
              ...
              o(this, 'storeName', 'files'),
              o(this, 'indexedDB', void 0),
              o(this, 'db', null),
              (this.version = t),
              (this.indexedDB =
                'undefined' == typeof window
              ...
              try {
                const o = this.indexedDB.open('js-dos-cache (' + t + ')', 1);
                ((o.onerror = t => {
                  var e;
                  n(
                ...
                n("Can't open cache database: " + t.message);
              }
          ...
          put(t, e) {
            return new Promise(n => {
              ...
              const o = this.db.transaction(this.storeName, 'readwrite');
              ((o.oncomplete = () => n()),
                o.objectStore(this.storeName).put(e, t));
            });
          }
          get(t, e) {
            return new Promise((n, o) => {
              function i(t) {
                void 0 === e ? o(new Error(t)) : n(e);
              }
              ...
              const r = this.db
                ...
                .get(t);
              ((r.onerror = () =>
                o(new Error("Can't read value for key '" + t + "'"))),
                (r.onsuccess = () => {
                  r.result
                    ? n(r.result)
                    : i(
          ...
          forEach(t, e) {
            ...
            ((n.onerror = () => e()),
              (n.onsuccess = n => {
                ...
                o ? (t(o.key.toString(), o.value), o.continue()) : e();
              }));
          }
        }
      },
    ...
    46: [
      function (t, e, n) {
        'use strict';
        (Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.load = n.save = void 0));
        const o = (0, t('./cache').makeCache)('emulators-ui-saves', {
          onErr: console.error,
        });
        ((n.save = function (t, e, n, i) {
          e.setOnSave(async () => {
            const e = await o,
              i = await n.persist();
            return e.put(t, i.buffer);
          });
        }),
          (n.load = async function (t, e) {
            return (await o).get(t).then(t => new Uint8Array(t));
          }));
      },
      { './cache': 45 },
    ],
    47: [
      function (t, e, n) {
        ...
        class o {
          ...
          length() {
            let t = 0;
            for (const e of this.samplesQueue) t += e.length;
            return t;
          }
          writeTo(t, e) {
            let n = 0;
            for (; this.samplesQueue.length > 0; ) {
              const o = this.samplesQueue[0],
                i = Math.min(e - n, o.length);
              if (
                (i === o.length
                  ? (t.set(o, n), this.samplesQueue.shift())
                  : (t.set(o.slice(0, i), n),
                    (this.samplesQueue[0] = o.slice(i))),
                (n += i),
                n === e)
              )
                break;
        ...
        n.audioNode = function (t) {
          ...
          if (
            ...
            return () => {};
          const i = new o();
          t.events().onSoundPush(t => {
            i.length() < 6144 && i.push(t);
          });
          const r = n.createScriptProcessor(2048, 0, 1);
          let s = !1,
            a = 0;
          const c = t.directSound;
          r.onaudioprocess =
            void 0 !== t.directSound
              ? t => {
                  if (!s) {
                    const t = c.buffer[0];
                    s = Math.ceil(t[t.length - 1]) > 0;
                  }
                  if (!s) return;
                  let e = 0,
                    n = t.outputBuffer.length;
                  const o = t.outputBuffer.numberOfChannels;
                  let i,
                    r = c.buffer[a];
                  for (; n > 0 && (i = Math.ceil(r[r.length - 1])) > 0; )
                    if (n >= i) {
                      const s = r.subarray(0, i);
                      for (let n = 0; n < o; ++n) {
                        t.outputBuffer.getChannelData(n).set(s, e);
                      }
                      ((e += i),
                        (n -= i),
                        (r[r.length - 1] = 0),
                      ...
                      const s = r.subarray(0, n);
                      for (let n = 0; n < o; ++n) {
                        t.outputBuffer.getChannelData(n).set(s, e);
                      }
                      ((r[r.length - 1] = i - n),
                        r.set(r.subarray(n, n + r[r.length - 1])),
                        (n = 0));
                    }
                }
              : t => {
                  const e = t.outputBuffer.length,
                    n = t.outputBuffer.numberOfChannels,
                    o = i.length();
                  if ((s || (s = o >= 2048), s))
                    for (let o = 0; o < n; o++) {
                      const n = t.outputBuffer.getChannelData(o);
                      i.writeTo(n, e);
                    }
                };
          const u = n.createGain();
          (u.connect(n.destination), r.connect(u), (u.gain.value = 1));
          const l = () => {
            null !== n && 'suspended' === n.state && n.resume();
          };
          return (
            document.addEventListener('click', l, { once: !0 }),
            document.addEventListener('touchstart', l, { once: !0 }),
            document.addEventListener('keydown', l, { once: !0 }),
            t.events().onExit(() => {
              (null !== n && (r.disconnect(), u.disconnect(), n.close()),
