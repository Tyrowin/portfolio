...
export declare type LayerControlType =
  | 'Options'
  | 'Key'
  | 'Keyboard'
  | 'Switch'
...
export type LegacyLayersConfig = Record<string, LegacyLayerConfig>;
export declare function extractLayersConfig(
  config: any
): LayersConfig | LegacyLayersConfig | null;
